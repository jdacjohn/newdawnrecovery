...
$body = "Someone has submitted the form to schedule a tentative assessment time from the New Dawn Treatment Centers website:\n\n"; foreach($fields as $a => $b){ $body .= sprintf("%20s: %s\n",$b,$_REQUEST[$a]); }
...
if($send)
{header( "Location: http://www.newdawnts.org/admissions/schedule-assessment/schedule-assessment-thank-you.php" );}
else

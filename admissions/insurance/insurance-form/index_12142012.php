...
<div id="MainContent">
<!--<div class="breadcrumbs"><a href="http://www.newdawnts.org/">Home</a> > <a href="http://www.newdawnts.org/insuranceform/">Insurance Form</a></div>-->
...
<p><input name="EatingDisorderTreatment" id="EatingDisorderTreatment"  type="radio" class="formfields" size="30" />&nbsp;&nbsp;<label id="EatingDisorderTreatment">Eating Disorder</label>&nbsp;&nbsp;
<input name="ChemicalDependencyTreatment" id="ChemicalDependencyTreatment"  type="radio" class="formfields" size="30" />&nbsp;&nbsp;<label id="ChemicalDependencyTreatment">Chemical Dependency</label></p>
</div>

<h2>Eating Disorder Questions</h2>

<table>	<tr class="formRow">
...
<tr class="formRow">
	<td class="field_label" valign="top" style="background-color: #fff !important;">&nbsp;</td>
	<td class="field">
		<input class="formfields"  type="checkbox" name="paymentmethod" value="Private insurance" /> Private insurance<br />
		<input class="formfields"  type="checkbox" name="paymentmethod" value="Self-pay" /> Self-pay<br />
		<input class="formfields"  type="checkbox" name="paymentmethod" value="Need financing" /> Need financing
...
<!-- -->
    ...
    <!-- -->
	<tr class="formRow">
		<td class="field_label" valign="top" colspan="2" style="text-align: left !important;">What problems had addiction caused the family?</td>
	</tr>
	<tr class="formRow">
		<td class="field_label" valign="top" style="background-color: #fff !important;">&nbsp;</td>
		<td class="field">
	...
	<tr class="formRow">
		<td class="field_label" valign="top" style="background-color: #fff !important;">&nbsp;</td>
		<td class="field">
			 <textarea class="formfields" name="help" cols="35" rows="3" id="desc4"></textarea>
        </td>
	</tr>
    <!-- -->
	<tr class="formRow">
		<td class="field_label">Current Medications:</td>
		<td class="field">
			<input class="formfields"  name="currentmed" type="text" size="35">
        </td>
	</tr>
<tr class="formRow">
...
<span class="formField"><select name="ReferredBy" id="ReferredBy" value="" class="formfields">
		<option value="" selected="selected"></option>
...
<input type="image" src="http://www.newdawnts.org/images/Submit_Btn.png" width="116" height="31">
</div>

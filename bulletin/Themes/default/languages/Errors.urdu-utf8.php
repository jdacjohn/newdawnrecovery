...
$txt[1] = 'آپ اس حصے کو دیکھنے کے مجاز نہیں ہیں';

$txt[73] = 'صرف مودرہتر یہان سے ختم کر سکتے ہے. براینے مہربانی آپ یہ پیغام موڈیفائی فیچر سے ختم کریں ';
$txt[75] = 'آپ نے نام کی جگہ کچھہ نہیں لکھا یہ ضروری ہے۔';
$txt[76] = 'آپ نےای میل کی جگہ کچھہ نہیں لکھا یہ ضروری ہے۔ ';
$txt[90] = 'یہ موضوع بند ہے آپ کو یہان لکھنے کی اجازت نہیں ہے ... ';
$txt[91] = 'پاسورڈ کی جگہ خالی ہے۔';
$txt[93] = 'آپ کو یہ موضوع بند یا کھولنے کی اجازت نہیں ہے ، آپ کا ایڈ منسترٹر یا موڈراٹر ہونا ضروری ہے ';
$txt[100] = 'رکن نام جو آپ نے دیا پہلے سے استمال مے ہے .';
$txt[134] = 'آپ کو موضوع ہلانے کی اجازت نہیں ہے .';
$txt[138] = 'یہ حدمت صرف ارکان کے لئے ہے .';
$txt[165] = 'پوسٹ کرنے ک لی رکن ہونا ضروری ہے .اگر آپ  رجسٹر نہیں ہے تو براۓ مہربانی یہان جائے  <a href="' . $scripturl . '?action=register">register</a>.';
$txt[213] = 'پاسورڈ ایک جیسے نہیں۔';
$txt[223] = ' معزرت یہ فیچر استمال کرنے کے لیے  رجسٹر ہونا ضروری ہے .';
$txt[241] = 'پاسوورڈ میں غلط الفاظ استمال کے گے';
$txt[242] = 'نام میں غلط الفاظ استمال کے گے  ';
$txt[243] = 'ای میل میں غلط الفاظ استمال کے گے  ';
$txt[244] = 'رکن نام جو آپ نے چنا پہلے سے محفوظ ہے براۓ مہربانی دوسرا نام چنیے ';
$txt[337] = 'یہان آپ صرف 0-9 تک لکھ سکتے ہے ';
$txt[472] = 'یہ موضوع اس بورڈ میں نہیں ہے .';

$txt['smf26'] = 'آپ نے کسی ووٹ کی آپشن سلیکٹ نہیں کی ';
$txt['smf27'] = 'یا تو پول موجود نہیں یا پول بند ہو چکا ہے یا پھر آپ دوسری دفع ووٹ دے رہے ہو -';
$txt['smf28'] = 'یہ آپشن صرف رجسٹرڈ ارکان کے لیے ہے .';
$txt['smf31'] = 'یہ ایک ا یڈمنسٹر نے بند کی ہے آپ سے نہیں کھول سکتے ';
$txt['smf61'] = 'معذرت آپ اپنا کرما ھود تبدیل نہیں کر سکتے ';
$txt['smf63'] = 'معذرت یہ فیچر ممنوع ہے . ';

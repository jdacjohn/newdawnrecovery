...
$txt[431] = 'Registratie gelukt! Je bent nu een lid van dit forum.';
// Use numeric entities in the below string.
$txt[492] = 'en je wachtwoord is';
$txt[500] = 'Vul een geldig e-mailadres in. (%s)';
$txt[517] = 'Verplichte velden';
$txt[520] = 'Wordt alleen gebruikt voor identificatie door SMF. Je kunt speciale karakters gebruiken nadat je bent ingelogd, door je naam aan te passen in je profiel.';
...
$txt['activate_not_completed1'] = 'Je email-adres moet eerst gevalideerd worden voor je kunt inloggen.';
...
$txt['admin_setting_notify_new_registration'] = 'Breng beheerders op de hoogte als een nieuw lid zich geregistreerd heeft';
...
$txt['admin_setting_image_verification_type'] = 'Moeilijkheidsgraad van de visuele verificatieafbeelding';
$txt['admin_setting_image_verification_type_desc'] = 'Hoe complexer de afbeelding, des te moeilijker het wordt voor bots om de verificatie te omzeilen.';
$txt['admin_setting_image_verification_off'] = 'Uitgeschakeld';
$txt['admin_setting_image_verification_vsimple'] = 'Erg eenvoudig - platte tekst als afbeelding';
...
$txt['admin_setting_image_verification_high'] = 'Hoog - gedraaide letters, veel ruis';
$txt['admin_setting_image_verification_sample'] = 'Voorbeeld';
$txt['admin_setting_image_verification_nogd'] = '<b>NB:</b> omdat deze server niet over de GD-bibliotheek beschikt, zullen de verschillende moeilijkheidsgraden geen effect hebben.';

$txt['admin_setting_coppaAge'] = 'Leeftijd waar beneden de restricties gelden';
...
$txt['visual_verification_request_new'] = 'Vraag een nieuwe afbeelding aan';
$txt['visual_verification_sound_direct'] = 'Problemen met het horen van het geluid? Probeer een directe link ernaar.';

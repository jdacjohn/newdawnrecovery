...
$txt['permissions_title'] = 'پرمیشنز کی ترکیب';
$txt['permissions_modify'] = 'تبدیلی';
$txt['permissions_access'] = 'رسائی';
$txt['permissions_allowed'] = 'اجازت ہے';
$txt['permissions_denied'] = 'انکار';

$txt['permissions_switch'] = 'سوئچ ٹو';
$txt['permissions_global'] = 'گلوبل';
$txt['permissions_local'] = 'لوکل';

$txt['permissions_groups'] = 'ارکان گروہ سے پرمیشنز';
$txt['permissions_all'] = 'تمام';
$txt['permissions_none'] = 'کوئی نہیں';
$txt['permissions_set_permissions'] = 'سیٹ پرمیشنز';

$txt['permissions_with_selection'] = 'چنے ہوئے کے ساتھ';
$txt['permissions_apply_pre_defined'] = 'پہلے سے بنائی گئی پروفائل پرمیشنز لگائے';
$txt['permissions_select_pre_defined'] = 'پہلے سے بنایا گیا پروفائل چنے ';
$txt['permissions_copy_from_board'] = 'اس فورم سے پرمیشنز کاپی کرے';
$txt['permissions_select_board'] = 'ایک فورم چنے';
$txt['permissions_like_group'] = 'اس گروہ کی طرح پرمیشنز چنے';
$txt['permissions_select_membergroup'] = 'ایک ارکان گروہ چنے';
$txt['permissions_add'] = 'پرمیشن جمع کرے';
$txt['permissions_remove'] = 'پرمیشن ختم کرے ';
$txt['permissions_deny'] = 'پرمیشن بند کرے';
$txt['permissions_select_permission'] = 'ایک پرمیشن چنے';

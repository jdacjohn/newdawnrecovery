...
$txt[183] = 'Các tham số tìm kiếm';
$txt[189] = 'Chọn diễn đàn để tìm, hoặc tìm trên tất cả';
$txt[343] = 'Có tất cả các từ';
$txt[344] = 'Có bất kỳ từ nào';
$txt[583] = 'tìm trong bài viết của thành viên';

$txt['search_post_age'] = 'Tìm theo thời gian';
$txt['search_between'] = 'Trong khoảng';
$txt['search_and'] = 'và';
$txt['search_options'] = 'Tùy chọn';
$txt['search_show_complete_messages'] = 'Hiện kết quả như các bài viết';
$txt['search_subject_only'] = 'Chỉ tìm trong tiêu đề';
$txt['search_relevance'] = 'Mật độ';
$txt['search_date_posted'] = 'Ngày gửi';
$txt['search_order'] = 'Thứ tự sắp xếp';
$txt['search_orderby_relevant_first'] = 'Mật độ xuất hiện từ cần tìm';
$txt['search_orderby_large_first'] = 'Chủ đề lớn nhất';
$txt['search_orderby_small_first'] = 'Chủ đề nhỏ nhất';
$txt['search_orderby_recent_first'] = 'Bài mới nhất';
$txt['search_orderby_old_first'] = 'Cũ nhất';

$txt['search_specific_topic'] = 'Chỉ tìm bài viết trong chủ đề';

$txt['mods_cat_search'] = 'Tìm';
$txt['groups_search_posts'] = 'Các nhóm thành viên được phép tìm kiếm';
$txt['simpleSearch'] = 'Mở chức năng tìm kiếm đơn giản';
$txt['search_results_per_page'] = 'Số kết quả trên 1 trang';
$txt['search_weight_frequency'] = 'Mật độ của các từ cần tìm trong chủ đề';

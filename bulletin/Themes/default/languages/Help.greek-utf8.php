...
$helptxt['titlesEnable'] = 'Switching Custom Titles on will allow members with the relevant permission to create a special title for themselves.
		This will be shown underneath the na?e.<br /><i>For example:</i><br />Jeff<br />Cool Guy';
...
$helptxt['attachmentEnable'] = 'Attachments are files that members can upload, and attach to a post.<br /><br />
		...
		<b>Attachments directory</b>:<br /> The path to your attachment fol?er<br />(example: /home/sites/yoursite/www/forum/attachments)<br />
...
$helptxt['localCookies'] = 'SMF uses cookies to store login information on the client computer.
	...
	Local cookies don\'t work outside the forum folder so, if your forum is stored at www.myserver.com/forum, pages li?e www.myserver.com/index.php cannot access the account information.
...
$helptxt['attachmentEncryptFilenames'] = 'Encrypting attachment filenames allows you to have more than one attachment of the
	same name, to safely use .?hp files for attachments, and heightens security.  It, however, could make it more
	...
	<ul>
		<li>
			<b>Registration Disabled:</b><br />
				Disables the registration process, which means that no new members can register to join your forum.<?r />
		</li><li>
...
$helptxt['membergroups'] = 'In SMF there are two types of groups that your members can be part of. These are:
	<ul>
		<li><b>Regular Groups:</b> A regular group is a group to which members are not automatically put into. To assign a member to be in a group simpl? go to their profile and click &quot;Account Settings&quot;. From here you can assign them any number of regular groups to which they will be part.</li>
...
$helptxt['search_weight_length'] = 'Weight factors are used to determine the relevancy of a search result. Change these weight factors to match the things that ?re specifically important for your forum. For instance, a forum of a news site, might want a relatively high value for \'age of last matching message\'. All values are relative in relation to each other and should be positive integers.<br /><br />This factor is based on the topic size. The more messages are within the topic, the higher the score.';

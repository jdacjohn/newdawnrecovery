...
$txt['smileys_upload_error_notwritable'] = 'The following smiley directories are not writeable:';

$txt['smileys_edit'] = 'Edit Smileys';
$txt['smileys_enable'] = 'Enable customised smileys';
$txt['smileys_enable_note'] = '(otherwise the default smileys will be used)';
$txt['smileys_code'] = 'Code';
$txt['smileys_filename'] = 'File name';
...
$txt['smiley_editsets_explain'] = 'Smiley Sets are groups of smileys your users can select.  For example, you might have yellow and red smileys.<br />You can change the name and location of each smiley set from here. Remember, however, that all sets share the same smileys.';
$txt['smiley_editsmileys_explain'] = 'Change your smileys here by clicking on the smiley you want to modify. Remember that these smileys all have to exist in all the sets or some smileys will not show up!  Do not forget to save after you have finished editing!';
$txt['smiley_setorder_explain'] = 'Change the order of the smileys here.';
$txt['smiley_addsmiley_explain'] = 'You can add a new smiley here either from an existing file or by uploading new ones.';
...
$txt['smiley_set_import_single'] = 'There is one smiley in this smiley set that has not yet been imported. Click';
...
$txt['icons_enable_customized'] = 'Enable customised message icons';
...
$txt['icons_edit_icons_explain'] = 'You can change which message icons are available throughout your board from here. You can add, edit and remove icons as well as limit their use to certain boards.';

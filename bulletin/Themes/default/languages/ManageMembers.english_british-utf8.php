...
$txt['membergroups_new_board_post_groups'] = '<em>Note: Post groups do not normally need access because the group the member is in will give them access.</em>';
$txt['membergroups_new_as_type'] = 'by type';
$txt['membergroups_new_as_copy'] = 'based on';
...
$txt['membergroups_edit_post_group'] = 'This group is based on posts';
$txt['membergroups_min_posts'] = 'Required posts';
$txt['membergroups_online_color'] = 'Colour in online list';
$txt['membergroups_star_count'] = 'Number of star images';
$txt['membergroups_star_image'] = 'Star image file name';
...
$txt['admin_browse_approve_desc'] = 'You can manage all members from here who are waiting to have their accounts approved.';
$txt['admin_browse_activate'] = 'Members whose accounts are awaiting activation';
$txt['admin_browse_activate_desc'] = 'All the members who have still not activated their accounts at your forum are listed here.';
...
$txt['admin_browse_no_members_approval'] = 'No members currently awaiting approval.';
...
$txt['admin_browse_filter_type_2'] = 'Unactivated Email Address Changes';
...
$txt['admin_approve_reject_desc'] = 'Sorry, your application to join ' . $context['forum_name'] . ' has been rejected.';

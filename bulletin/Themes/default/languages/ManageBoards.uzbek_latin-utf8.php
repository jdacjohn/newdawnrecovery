...
$txt['parent_members_only'] = 'Doimiy foydalanuvchilar';
$txt['parent_guests_only'] = 'Mehmonlar';
$txt['catConfirm'] = 'Siz haqiqatdan ham ushbu yo`nalishni o`chirmoqchimisiz?';
$txt['boardConfirm'] = 'Siz haqiqatdan ham ushbu bo`limni o`chirmoqchimisiz?';
...
$txt['mboards_delete_board'] = 'Bo`limni o`chirish';
...
$txt['mboards_delete_board_error'] = 'Hech qanday bo`lim tanlanmagan!';
$txt['mboards_delete_what_do'] = 'Please select what you would like to do with these boards';
$txt['mboards_delete_confirm'] = 'Joriy qilish';
$txt['mboards_delete_cancel'] = 'Bekor qilish';
...
$txt['mboards_groups'] = 'Ruzsat etilgan guruhlar';
...
$txt['mboards_moderators'] = 'Nazoratchilar';
...
$txt['mboards_count_posts'] = 'Postlarni sanash';
$txt['mboards_count_posts_desc'] = 'Makes new replies and topics raise members\' post counts.';
$txt['mboards_unchanged'] = 'O`zgarmagan';
$txt['mboards_theme'] = 'Bo`lim mavzusi';
...
$txt['mboards_order_before'] = 'Oldin';
...
$txt['mboards_settings_submit'] = 'Saqlash';
...
$txt['mboards_cancel_moving'] = 'Ko`chirishni bekor qilish';
$txt['mboards_move'] = 'Ko`chirish';

...
$txt[1] = 'Sizga ushbu bo`limga kirishga ruxsat berilmagan';

$txt[73] = 'Only Moderators can use the direct remove function, please remove this message through the modify feature.';
$txt[75] = 'Ismini kiriting.  Ism kiritish shart.';
$txt[76] = 'E-mailni kiriting. E-mailni kiritish shart.';
$txt[90] = 'Ushbu mavzu yopilgan. Siz ushbu mavzuga javob ham bera olmaysiz, javoblarni o`zgartira olmaysiz ham...';
$txt[91] = 'Parolni kiriting';
$txt[93] = 'Sizga ushbu mavzuni yopishga yoki ochishga ruxsat berilmagan; Ushbu amaliyotni qilishingiz uchun siz yo nazoratchi yo boshqaruvchi bo`lishingiz kerak...';
$txt[100] = 'Buznday a`zo ro`yxatda bor.';
$txt[134] = 'Sizga mavzularni ko`chirishga ruxsat berilmagan...';
$txt[138] = 'Bu xizmat faqat foydalanuvchilar  uchun...';
$txt[165] = 'Javob berish uchun forumga a`zo sifatida kirishingiz kerak. Agar siz ro`yxatdang o`tmagan bo`lsangiz, iltimos <a href="' . $scripturl . '?action=register">ro`yxatdan o`ting</a>.';
$txt[213] = 'Parollar bir-biriga mos kelmayapti.';
$txt[223] = 'Kechirasiz avval ro`yxatdan o`tishingiz kerak.';
$txt[241] = 'Parol sifatida ruxsat berilmagan belgilar kirildi.';
$txt[242] = 'Ism sifatida ruxsat berilmagan belgilar kiritildi.';
$txt[243] = 'E-mail sifatida ruxsat berilmagan belgilar kiritildi.';
$txt[244] = 'Iltimos, ism sifatida boshqa so`z kiriting.';
$txt[337] = 'Bu yerga faqatgina 0-9 doiradagi raqamlargina kiritilishi mumkin';
$txt[472] = 'Ushbu bo`limda bunday mavzu yo`q.';

$txt['smf26'] = 'Javob tanlamadingiz.';
$txt['smf27'] = 'Yoki bunday javob yo`q, yoki so`rovnoma yopilgan, yoki siz ikki marta ovoz berishga urindingiz.';
$txt['smf28'] = 'Ushbu amaliyot faqatgina ro`yxatdan o`tgan a`zolar uchun.';
$txt['smf31'] = 'Bu boshqaruvchi tomonidan yopilgan.  Siz buni ocha olmaysiz.';
$txt['smf61'] = 'Kechirasiz siga o`z karmangizni o`zgartirishga ruxsat berilmagan.';
$txt['smf63'] = 'Kechirasiz, ushbu imkoniyat o`chirilgan.';
$txt['smf115b'] = 'Yuklash imkoniyatidan foydalanishning imkoni yo`q!';
$txt['smf122'] = 'Siz yuklamoqchi bo`lgan fayl juda katta. Yuklashga ruxsat berilgan eng katta hajm %d KB.';
$txt['smf124'] = 'Yuklagan faylingiz xotiraga olinmadi. Sababi yuklash jarayoni juda cho`zilib ketganligi yoki server bunday katta hajmdagi faylni yuklamasigi bo`lishi mumkin.<br /><br />Iltimos, boshqaruvchi bilan bo`laning.';
$txt['smf125'] = 'Kechirasiz, siz yuklamoqchi bo`lgan fayl nomidagi fayl serverga allaqachon yuklangan. Iltimos, faylni qayta nomlang va yana urinib ko`ring.';
$txt['smf126'] = 'Fayllar papkasi to`lgan. Iltimos, kichikroq fayl yuklang yoki boshqaruvchi bilan bog`laning.';
$txt['smf191'] = 'Serverga ulanishning imkoni bo`lmadi yoki fayl topilmadi';
$txt['smf232'] = 'Siz tanlagan bo`lim mavjud emas';
$txt['smf253'] = 'Sizga mavzularni bo`lishga ruxsat berilmagan';
$txt['smf262'] = 'Sizga mavzularni biriktirishga ruxsat berilmagan';
$txt['smf263'] = 'Mavzu uchun yaroqsiz ID tanladingiz.';
$txt['smf268'] = 'Birinchi javobdanoq mavzuni bo`la olmaysiz.';
$txt['smf270'] = 'Ushbu mavzuda bitta javob borligi sababli uni bo`lishning imkoni yo`q.';
$txt['smf271'] = 'javob tanlanmagan';
$txt['smf271b'] = 'Bo`lishning imkoni yo`q. Siz barcha javoblarni tanladingiz.';
$txt['smf272'] = 'Javoblar topilmadi';
$txt['smf273'] = 'Mavzuni kiritishnin imkoni bo`lmadi';
$txt['smf289'] = 'Siz ro`yxatdan o`tgan nazoratchi ismini kiritdingiz. Iltimos, boshqasini kiriting';
$txt['smf304'] = 'Javob berish paytida siz uchun ajratilgan muddat nihoyasiga yetti.  Iltimos, yana urinib ko`ring.';
$txt['smf305'] = 'Muddatni tekshirishning imkoni bo`lmadi.  Iltimos forumdan chiqib, qaytadan a`zo sifatida kiring va yana urinib ko`ring.';
$txt['smf306'] = 'Unable to verify referring url.  Please go back and try again.';

$txt['cannot_admin_forum'] = 'Sizga ushbu forumni boshqarishga ruxsat berilmagan.';
$txt['cannot_announce_topic'] = 'Sizga ushbu bo`limdagi mavzularni e`lon qilishga ruxsat berilmagan.';
$txt['cannot_calendar_edit_any'] = 'Siz ushbu taqvim yangiliklarini o`zgartira olmaysiz.';
$txt['cannot_calendar_edit_own'] = 'You don\'t have the privileges necessary to edit your own events.';
$txt['cannot_calendar_post'] = 'Kechirasiz, taqvimga yangilik kiritishga ruxsat berilmagan.';
$txt['cannot_calendar_view'] = 'Kechirasiz, sizga taqvimni ko`rishga ruxsat berilmagan.';
$txt['cannot_remove_any'] = 'Sorry, but you don\'t have the privilege to remove just any topic.';
$txt['cannot_remove_own'] = 'Siz ushbu bo`limdagi o`z mavzularingizni o`chira olmaysiz.';
$txt['cannot_edit_news'] = 'Sizga ushbu forum yangiliklari o`zgartirishga ruxsat berilmagan.';
...
$txt['register_only_once'] = 'Kechirasiz, sizga bir vaqtning o`zida bitta kompyuterdan bir necha marta ro`yxatdan o`tishga ruxsat berilmagan.';

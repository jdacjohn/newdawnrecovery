...
$helptxt['manage_boards'] = '
	...
	globale categorie. Als je wilt discussiëren over &quot;Pinto\'s&quot;, dan
...
$helptxt['live_news'] = '<b>Live aankondigingen</b><br />
	Deze box toont recente aankondigingen van <a href="http://www.simplemachines.org/" target="_blank">www.simplemachines.org</a>.
...
$helptxt['allow_disableAnnounce'] = 'Hierdoor kunnen gebruikers de aankondiginging, die door &quot;kondig topic aan&quot; aan te vinken bij het plaatsen van een bericht wordt verstuurd, uitzetten.';
...
$helptxt['removeNestedQuotes'] = 'Deze optie zorgt ervoor dat alleen de aangehaalde post geciteerd wordt, en niet de citaten die al in de post in kwestie aanwezig zijn.';
...
$helptxt['registration_method'] = 'Deze optie bepaalt welke registratie methode wordt gebruikt op het forum. Je kunt kiezen uit:<br /><br />
	<ul>
		<li>
			<b>Registratie niet geactiveerd:</b><br />
...
$helptxt['password_strength'] = 'Deze instelling bepaalt de vereiste sterkte van wachtwoorden die gebruikt worden door je forumleden. Hoe &quot;sterker&quot; het wachtwoord, hoe moeilijker het is om iemands account te kraken.
	...
	<ul>
		...
		<li><b>Hoog:</b> Net zoals bij middel, behalve dat het wachtwoord ook een mix van hoofd- en kleine letters moet bevatten en tenminste &eacute;&eacute;n nummer.</li>
	</ul>';
...
$helptxt['moderator_why_missing'] = 'Daar modereren gedaan wordt op basis van boards, dien je leden moderator te maken via de <a href="javascript:window.open(\'' . $scripturl . '?action=manageboards\'); self.close();">board management interface</a>.';
...
$helptxt['permissions_by_board'] = 'Door deze optie aan te zetten kun je voor elk board voor elke ledengroep verschillende permissies instellen. Standaard zal een board de algemene permissies gebruiken, maar met deze optie ingeschakeld is het mogelijk om een board te switchen naar lokale permissie-instellingen. Hiermee wordt het mogelijk om op zeer gedetailleerd niveau je permissies te beheren.';
...
$helptxt['avatar_allow_server_stored'] = 'Hier kunnen leden een avatar kiezen die is opgeslagen op je server. Normaal gesproken zijn ze te vinden onder de dezelfde plek als SMF in de avatar directory te vinden.<br />Tip : Als je directories aanmaakt in de map waar de avatars staan, kun je &quot;categorie&euml;n&quot; maken van de avatars.';
$helptxt['avatar_allow_external_url'] = 'Met deze optie actief kunnen leden een URL opgeven naar hun avatar.  Het nadeel hiervan is dat in sommige gevallen er avatars zullen worden gebruikt die erg groot zijn of niet op je forum kunnen in verband met wat de afbeelding voorstelt.';
...
$helptxt['avatar_allow_upload'] = 'Deze optie is vrijwel gelijk aan &quot;Sta leden toe een externe avatar te gebruiken&quot;, alleen heb je nu een betere controle over de avatars, gaat het resizen sneller en hoeven de leden hun avatar niet elders onder te brengen.<br /><br />Het nadeel kan echter zijn dat het een hoop ruimte kan gaan kosten op je server.';

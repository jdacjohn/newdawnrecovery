...
$txt['smiley_sets_enable'] = 'Włącz możliwość wyboru zestawu emotikon przez użytkowników.';
$txt['smiley_sets_base_url'] = 'Bazowy URL do wszystkich zestawów emotikon';
...
$txt['smileys_add'] = 'Dodaj emotikonę';
...
$txt['smileys_upload_error_types'] = 'Obrazek może mieć jedno z następujących rozszerzeń:';
$txt['smileys_upload_error_notwritable'] = 'Następujące katalogi emotikon są chronione przed zapisem:';

$txt['smileys_edit'] = 'Modyfikuj emotikony';
$txt['smileys_enable'] = 'Włącz niestandardowe emotikony';
...
$txt['smileys_show_on_post'] = 'Pokazuj w formularzu wiadomości';
...
$txt['smiley_sets_base_dir'] = 'Ścieżka dostępu do wszystkich zestawów emotikon';
...
$txt['smiley_set_import_multiple'] = 'Niezaimportowanych emotikon w zestawie: %d. Kliknij';
...
$txt['icons_enable_customized'] = 'Włącz niestandardowe ikony wiadomości';
$txt['icons_enable_customized_note'] = '(w przeciwnym wypadku zostaną użyte domyślne ikony)';

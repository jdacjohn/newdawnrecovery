...
$txt[25] = 'Post reply';
$txt[71] = 'Message icon';
$txt[77] = 'The Subject field has not been completed but is required.';
$txt[78] = 'The Message Body has not been completed but is required.';
...
$txt['notify_boards_once'] = 'More topics may be posted but you will not receive more email notifications until you return to the board and read some of them.';
$txt['notifyUnsubscribe'] = 'Click here to unsubscribe from this topic';
$txt['notify_boardsUnsubscribe'] = 'Click here to unsubscribe from new topics on this board';

$txt['smf13'] = 'Lock after Post';
$txt['smf14'] = 'Notify me of replies';
$txt['smf15'] = 'Lock this topic';
$txt['smf16'] = 'Shortcuts: Alt+s to submit/post or Alt+p to preview';
$txt['smf22'] = 'Option';
...
$txt['smf129'] = 'Leave this blank to delete your attachment.';
$txt['smf130'] = 'Uncheck the attachments you no longer want attached';
$txt['smf130b'] = 'That is a restricted file name. Please try a different file name.';
...
$txt['notifyXOnce2'] = 'More replies may be posted but you will not receive any more notifications until you read the topic.';
...
$txt['poll_error1'] = 'You selected too many options. You may only select %s options for this poll.';
...
$txt['error_old_topic'] = 'Warning - This topic has not been posted in for at least ' . $modSettings['oldTopicDays'] . ' days.<br />Unless you are sure you want to reply, please consider starting a new topic.';
...
$txt['announce_desc'] = 'You can send an announcement to the selected membergroups about this topic using this form.';

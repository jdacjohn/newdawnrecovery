...
$txt['mods_cat_features'] = 'Taybetiyên Bingehîn';
$txt['pollMode'] = 'Moda Anketê';
$txt['smf34'] = 'Anketan Neçalak Bike';
$txt['smf32'] = 'Anketan Çalak Bike';
$txt['smf33'] = 'Anketên heyî wekî mijar nîşan bide';
$txt['allow_guestAccess'] = 'Destûr bide mêvanan ku forumê bibînin';
$txt['userLanguage'] = 'Bihêle ku bikarhêner zimanê forumê hilbijêre';
$txt['allow_editDisplayName'] = 'Bihêle ku bikarhêner navê xwe yê dixuye biguhere?';
$txt['allow_hideOnline'] = 'Bihêle ku yên ne rêvebir jî bikarin rewşa xwe ye girêdayî veşêrin?';
$txt['allow_hideEmail'] = 'Destûr bide ku bikarhêner e-peyama xwe ji xeynî rêvebir ji yên din veşêre?';
$txt['guest_hideContacts'] = 'Berfırehiya agahiyên endaman nîşanî mêvanan nede';
$txt['titlesEnable'] = 'Enable custom titles';
$txt['enable_buddylist'] = 'Enable buddy lists';
$txt['default_personalText'] = 'Nivîsa Kesane ya Bixweber';
$txt['max_signatureLength'] = 'Di îmzayêde sînora karekteran<div class="smalltext">(0 yanî herî zêde.)</div>';
$txt['number_format'] = 'Formata hejmaran ya bixweber';
$txt['time_format'] = 'Formata Saetê ya bixweber';
$txt['time_offset'] = 'Overall time offset<div class="smalltext">(added to the member specific option.)</div>';
$txt['failed_login_threshold'] = 'Sînora têketina çewt';
$txt['lastActive'] = 'Sînora girêdayîmayîna bikarhêner';
...
$txt['who_enabled'] = 'Lîsteya kî girêdayî ye, çalak bike';

...
$txt['smf92'] = 'All errors fixed! You will want to check on any created categories, boards, or topics to decide what to do with them.';
...
$txt['ban_notes'] = 'Notes';
$txt['ban_restriction'] = 'Ограничения';
$txt['ban_full_ban'] = 'Пълна Забрана';
...
$txt['ban_days'] = 'ден(дни)';
$txt['ban_will_expire_within'] = 'Ban will expire after';
$txt['ban_added'] = 'Добавен';
$txt['ban_expires'] = 'Изтича';
$txt['ban_hits'] = 'Опити';
...
$txt['default_language'] = 'Език на форума по подразбиране';
...
$txt['attachment_manager_save'] = 'Съхрани';
...
$txt['avatar_directory'] = 'Директория за аватарите';
$txt['avatar_url'] = 'Avatars URL';
$txt['avatar_dimension_note'] = '(0 = без ограничение)';
...
$txt['repair_attachments_continue'] = 'Продължи';
$txt['repair_attachments_cancel'] = 'Отказ';
...
$txt['news_settings_submit'] = 'Съхрани';
...
$txt['manageposts_characters'] = 'символи';
$txt['manageposts_days'] = 'дни';
$txt['manageposts_posts'] = 'публикации';
$txt['manageposts_topics'] = 'теми';

$txt['manageposts_settings'] = 'Публикуване - Настройки';
$txt['manageposts_settings_description'] = 'Here you can set everything related to posts and posting.';
$txt['manageposts_settings_submit'] = 'Запази';
...
$txt['manageposts_bbc_settings_submit'] = 'Запази';
...
$txt['manageposts_topic_settings_submit'] = 'Запази';

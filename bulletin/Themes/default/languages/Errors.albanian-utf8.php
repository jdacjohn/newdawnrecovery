...
$txt[1] = 'Ju nuk jeni te lejuar te hyni ne kete seksion';

$txt[73] = 'Vetem Moderatoret mund te perdorin funksionin e heqjes direkte, ju lutemi hiqeni kete mesazh nga opsioni i modifikimit.';
$txt[75] = 'Ju nuk vendoset emrin.  Eshte i domosdoshem.';
$txt[76] = 'Ju nuk vendoset adresen e e-mailit.  Eshte i domosdoshem.';
$txt[90] = 'Kjo teme eshe e mbyllur, ju nuk jeni te autorizuar te postoni ose modifikoni mesazhe...';
$txt[91] = 'Fusha e fjalekalimit eshte bosh';
$txt[93] = 'Ju nuk jeni te autorizuar ta mbyllni ose ta hapni kete teme; Duhet te jeni Moderator ose Administrator per ta bere ate...';
$txt[100] = 'Emri i perdoruesit qe zgjodhet egziston: Ju lutemi zgjidhni nje tjeter.';
$txt[134] = 'Nuk jeni te autorizuar te levizni temat...';
$txt[138] = 'Kjo mundesi eshte vetem per anetaret...';
$txt[165] = 'Qe te filloni te postoni duhet te lidheni. Nqs nuk keni nje llogari akoma, ateher ju lutemi <a href="' . $scripturl . '?action=register">regjistrohuni</a>.';
$txt[213] = 'Fjalekalimet nuk jane njelloj.';
$txt[223] = 'Njoftim, duhet te regjistroheni para se te filloni te perdorni kete funksion.';
$txt[241] = 'Karaktere te gabuara jane perdorur per Fjalekalimin.';
$txt[242] = 'Karaktere te gabuara jane perdorur per Emrin.';
$txt[243] = 'Karaktere te gabuara jane perdorur per Email.';
$txt[244] = 'Emri qe ju zgjodhet permban nje emer te rezervuar i cili eshte \'%s\'. Ju lutemi zgjidhni nje tjeter.';
$txt[337] = 'Kjo fushe pranon vetem numra nga 0-9';
$txt[472] = 'Kjo teme nuk egziston ne kete rubrike.';

$txt['smf26'] = 'Ju nuk zgjodhet nje opsion votimi.';
...
$txt['error_query_not_specific_enough'] = 'Your query was not specific enough. Try using larger words, or less common phrases.';

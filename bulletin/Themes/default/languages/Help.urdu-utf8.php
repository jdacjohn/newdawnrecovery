...
$txt[1006] = 'ونڈو بند کریں';

$helptxt['manage_boards'] = '
	<b>فورم تبدیلی</b><br />
	اس مینیو میں آپ نیا فورم یا انکے اوپر قسم زمرہ یعنی کیٹگری کو بنا یا گھما یا ختم کر سکتے ہیں۔  مثال کے طور پہ اگر آپکی ویب سایٹ بڑی ہے اور &quot;کھیلوں&quot; اور &quot;گاڑیوں&quot; اور &quot;موسیقی&quot; کے متعلق ہے تو یہ ٹاپ لیول کی قسم یعنی کیٹگری ہوگی۔ انکے نیچے آپ انکی مزید شاخیں بنانا چاہیں گے جیسے کے زیرقسم یعنی سب کیٹگری یا فورم یا موضوعات: <br />
	<ul>
		<li>
			<b>کھیلیں</b>
			&nbsp;-ایک &nbsp;&nbsp;کیٹگری
		...
		<ul>
			<li>
				<b>بیس بال</b>
				&quot;-ایک فورم جو &quot;کھیلوں&quot; کی کیٹگری میں ہے
			</li>
			<ul>
				<li>
					<b>صورتحال۔سٹےٹس</b>
					&nbsp;-ایک فورم کی شاخ جو &nbsp;بیس بال&nbsp;  کے فورم کے نیچے ہے
				</li>
			</ul>
			<li><b>فٹ بال</b>
			&nbsp;-ایک فورم جو &nbsp;کھیلیں&nbsp;  کی کیٹگری کے نیچے ہے </li>
		</ul>
	</ul>
        کیٹگری مں آپ نیا فورم موضوع (جیسے کھیلیں,گاڑیاں) بنا سکتے ہیں ۔ 
...
$helptxt['edit_news'] = '<b>فارم خبریں ایڈٹ </b><br /> 
یہاں پر آپ اپنے فارم کی خبریں لکھ سکتے ہیں جو مرکزی صفحہ پر دکھائی جائیں گی۔ مثال کے طور پہ آپ لکھ سکتے ہیں سوموار کو چھٹی ہے وعیروغیرہ۔ ہر خبر الگ سے دوسرے خانے میں لکھی جائے گی اور بےترتیبی سے دکھائی جائے گ۔';
...
$helptxt['modsettings'] = '<b>فیچرز اور آپشنز ایڈٹ</b><br /> اس سیکشن میں بہت سارے فیچرز ہیں جو آپ اپنی ضرورت کے مصابق تبدیل کر سکتے ہیں۔ انسٹال شدہ موڈز کی آپشنز بھی عام طور پر یہیں ملے گی۔';
...
$helptxt['live_news'] = '<b>زندہ تشھیرات</b><br />
یہ خانہ تازہ ترین ۔یہاں پر<a href="http://www.simplemachines.org/" target="_blank">www.simplemachines.org</a> لکھی ہوئی تشھیرات یا اعلانات دکھاتا ہے۔ آپ یہاں پر آپ سمپل مشینز سے نکلی ہوئی نئی اپڈیٹز نئی ریلیزز اور نئی انفارمیشن دیکھہ سکتے ہیں۔';
...
$helptxt['calendar'] = '<b>ترتیب کیلنڈر</b><br />
یہاں پر آپ کیلنڈر کی موجودہ سیٹنگ تبدیل کر سکتے ہیں اور نئی چھٹیاں لکھ یا ختم کر سکتے ہیں۔';
...
$helptxt['topicSummaryPosts'] = 'یہاں آپکو پچھلی پوسٹز جو جوابی سکرین کے خلاصہ موضوع میں دکھائی جاتی ہیں کے نمبرز کو سیٹ یعنی بدل سکتے ہیں ۔';
...
$helptxt['allow_guestAccess'] = 'اس خانے کوان چیک کرنے سے آپکے فارم کے مہمان صرف بنیادی اقدام کر سکتے ہیں جیسے کہ لاگ ان یا رجسٹر یا پاسورڈ یاددہانی۔ یہ اس طرح نہیں ہے کہ آپ مہمان وژٹرز کو فورم میں داخل ہونے سے روکیں۔';
$helptxt['userLanguage'] = 'یہ آپشن آن کرنے سے ارکان کو اجازت ہوگی کے وہ اپنی مرضی کی زبان  کا انتخاب کر سکیں۔  اس سے ڈیفالٹ سلیکشن پر کوئی فرق نہیں پڑتا';
...
$helptxt['topbottomEnable'] = 'یہ اوپر جائیں اور نیچے جائیں کے بٹنز ڈال دے گی جس سے ارکان سکرولنگ کے بغیر صفحے کے اوپر یا نیچے جا سکتے ہیں۔ ';
$helptxt['onlineEnable'] = 'یہ ایک ایسی تصویر دکھائے گی جس سے کوئی رکن آف لائن یا آن لائن ظاہر ہو گا۔';
$helptxt['todayMod'] = 'یہ تاریخ کی بجائے &quot;آج&quot; یا &quot;کل&quot; دکھائے گا۔';
$helptxt['enablePreviousNext'] = 'یہ اگلے اور پچھلے صفحے کے لیے ایک لنک رابطہ دکھائے گا۔';
...
$helptxt['enableVBStyleLogin'] = 'یہ مہمانوں کے لیے مزید پیوستہ لاگ ان ہر صفحے پر دکھائے گا۔';
$helptxt['enableCompressedOutput'] = 'یہ اپشن آؤٹ پٹ کو دبائے گی جس سے بینڈوڈتھ کم خرچ ہو گی۔ لیکن اس کے لیے zlib کا انسٹال ہونا ضروری ہے۔';
$helptxt['databaseSession_enable'] = 'یہ آپشن ڈیٹابیس میں سیشن سٹور کرنے کے لیے استعمال ہوتی ہے۔ یہ بیلنسڈ سرور کے لوڈ کے لیے بہتر ہے لیکن تمام ٹائم آؤٹ اشوز کے لیے مددگار ہے اور فارم کو تیز کرسکتی ہے۔';
...
$helptxt['enableErrorLogging'] = 'یہ کوئی بھی غلطی ایرر لاگ میں ڈال دے گی جیسے لاگ ان فیل ہوا ہو۔ تو آپ ایرر لاگ میں دیکھ سکتے ہیں کیا غلط ہوا۔';
...
$helptxt['compactTopicPagesEnable'] = 'یہ صرف صفحات کی تعداد کا انتخاب دکھائے گی ۔<br />
<i>مثال:</i>
&quot;3&quot; کو دکھانا: 1 ... 4 [5] 6 ... 9 <br />  &quot;5&quot; کو دکھانا: 1 ... 3 4 [5] 6 7 ... 9 ';
$helptxt['timeLoadPageEnable'] = ' یہ صفحے کے آخر میں سیکنڈوں میں دکھائے گا کہ کسی صفحے کو کھولنے میں SMF نے کتنا وقت لگایا۔';
$helptxt['removeNestedQuotes'] = 'یہ صرف پوسٹ کے حوالیہ نشان کو سوال میں دکھائے گی ناکہ پوسٹز اس پوسٹ سے۔';
$helptxt['simpleSearch'] = 'یہ ایک سادہ تلاش فورم دکھائے گی اور ایک لنک ہو گا زیادہ ایڈوانس تلاش فورم کا۔';
$helptxt['max_image_width'] = 'اس سے آپ کسی پوسٹ کی ہوئی تصویر کا زیادہ سے زیادہ سائز متعین کر سکتے ہیں۔ اس سائز سے چھوٹی تصویر پر کوئی فرق نہیں پڑے گا۔';
...
$helptxt['theme_install'] = 'یہاں سے نیا ڈیزائن استعمال کر سکتے ہیں۔ آپ ایسا کر سکتے ہیں کسی پہلے سے بنی ہوئی ڈائریکٹری میں ڈیزائن کی آرچیو اپ لوڈ کر کے یا ڈیفالٹ ڈیزاین کی کاپی کر کے<br /><br />۔ یاد رکھیں کہ  آرچیو یا ڈائریکٹری میں <tt>theme_info.xml</tt> ڈیفینیشن فائل ضرور ہونی چاہیے۔';
$helptxt['enableEmbeddedFlash'] = 'یہ آپکے ارکان کو ڈائریکٹلی فلیش استعمال کرنے کی اجازت ہو گی جس طرح کہ تصویریں۔ ئہ ایکسیکیورٹی خطرہ ہے اگرچہ کچھ نے کامیابی سے اسے چلایا ہے۔ اسے استعمال کرنا آپکی اپنی ذمہ داری ہو گی۔';
// !!! Add more information about how to use them here.
$helptxt['xmlnews_enable'] = 'یہ لوگوں کو<a href="\' . $scripturl . \'?action=.xml;sa=news">تازہ خبزیں</a> اور اسی طرح کے ڈیٹا پہ لنک کرنے کی اجازت دیتی ہے۔ یہ بھی ریکومینڈ کیا جاتا ہے کہ آپ نئی پوسٹز یا خبریں محدود رکھیں تاکہ جب آر ایس ایس ڈیٹا کسی کلائنٹ جیسے Trillian میں دکھایا جائے تو ٹرنکیٹڈ ہونے کی امید ہو۔';
$helptxt['hotTopicPosts'] = 'پوسٹز نمبرز متعین کریں جو کسی موضوع کو &quot;دلچسپ&quot; یا &quot;زیادہ دلچسپ&quot; بیان کریں۔';
...
$helptxt['securityDisable'] = 'یہ ایڈمنسٹریٹر سیکشن کی بہت زیادہ چیکنگ کو بند کرتی ہے۔ یہ ریکومینڈ نہیں ہے۔';
$helptxt['securityDisable_why'] = 'یہ آپ کا موجودہ پاسورڈ ہے جوآپ لاگ ان کرنے میں استعمال کرتے ہیں۔<br /><br /> اس سے یقینی ہو جاتا ہے کہ آپ ہی کوئی ایڈمنسٹریٹو تبدیلی لا رہے ہو نہ گہ کوئی اور۔';
...
$helptxt['failed_login_threshold'] = 'نمبر متعین کریں کہ کتنی لاگ ان کی ناکام کوششوں کے بعد رکن کو پاسورڈ یاددہانی کی سکرین فورم پر بھیجا جائے۔ ';
...
$helptxt['edit_wait_time'] = 'کتنے سیکنڈوں کے بعد کسی پوسٹ کی ایڈٹنگ کو لاگ کیا جائے متعین کریں۔';
...
$helptxt['enableParticipation'] = 'یہ ایک چھوٹا سا آئیکون یعنی شپیھ ان موضوعات پر دکھاتی ہے جہاں رکن نے پوسٹ لیا ہو۔';

$helptxt['db_persist'] = 'یہ کنکشن کو ایکٹو رکھ تاکہ کارکردگی میں اضافہ ہو۔ اگر آپ ایک ڈیڈیکیٹیو سرور پر نہیں ہیں تو شاید یہ آپ کے ہوسٹ سے مسئلہ کی وجہ بن جائے۔';

$helptxt['queryless_urls'] = 'یہ URLs کے فارمیٹ کو تھوڑا تبدیل کرتی ہے جو سرچ انجنز کے لیے مناسب ہے۔ کچھ اس طرح سے دکھیں گے index.php/topic,1.html۔ یہ فیچر \' . (strpos(php_sapi_name(), \'apache\') !== false ? \'\' : \'not\') . \' آپ کے سرور پر کام کرے گا۔.\' ';

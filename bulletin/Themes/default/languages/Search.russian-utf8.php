...
$txt['search_create_index_done'] = 'Индексирование создано!';
$txt['search_create_index_done_link'] = 'Продолжить';
$txt['search_double_index'] = 'Ваша таблица сообщений использует два созданных индексирования. Для улучшения производительности, рекомендуется удалить одно из созданных индексирований.';

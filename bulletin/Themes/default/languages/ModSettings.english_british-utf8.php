...
$txt['smf3'] = 'You can change the settings of features, mods and basic options in your forum from here.  Please see the <a href="' . $scripturl . '?action=theme;sa=settings;th=' . $settings['theme_id'] . ';sesc=' . $context['session_id'] . '">theme settings</a> for more options.  Click the help icons for more information about a setting.';
...
$txt['allow_hideEmail'] = 'Allow users to hide their email address from everyone except admins';
...
$txt['localCookies'] = 'Enable local storage of cookies<div class="smalltext">(SSI will not work well with this on)</div>';
...
$txt['send_validation_onChange'] = 'Require reactivation after email address change';
$txt['approveAccountDeletion'] = 'Require admin approval when member deletes account';
$txt['autoOptDatabase'] = 'Number of days between tables optimisation<div class="smalltext">(0 to disable)</div>';
$txt['autoOptMaxOnline'] = 'Maximum users online when optimising<div class="smalltext">(0 for no max)</div>';
...
$txt['max_image_width'] = 'Max width of posted pictures (0 to disable)';
$txt['max_image_height'] = 'Max height of posted pictures (0 to disable)';
...
$txt['max_pm_recipients'] = 'Max number of recipients allowed in a personal message<div class="smalltext">(0 for no limit, admins are exempt)</div>';
$txt['pm_posts_verification'] = 'Min post count below which users must enter code when sending personal messages<div class="smalltext">(0 for no limit, admins are exempt)</div>';
...
$txt['caching_information'] = '<div align="center"><b><u>Important! Read this first before enabling these features.</b></u></div><br />
	...
	Caching will only work on your server if you have PHP compiled with one of the above optimisers or have memcache
	available. <br /><br />
	...
	<br /><br />
	You need to provide the server details in the setting below if you use memcached. This should be entered as a comma separated list
	as shown in the example below:<br />
	&quot;server1,server2,server3:port,server4&quot;<br /><br />
	SMF will use port 11211 if no port is specified and will attempt to carry out rough/random load balancing across the servers.
	<br /><br />
	%s
	<hr />';

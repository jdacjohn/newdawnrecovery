...
$txt['smf_stats_1'] = 'Statistics Centre';
...
$txt['smf_news_error2'] = 'You cannot specify a board that does not allow guests.  Please check the board ID before trying again.';

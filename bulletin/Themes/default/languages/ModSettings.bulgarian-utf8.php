...
$txt['send_validation_onChange'] = 'Email new password on email change';
...
$txt['smf293'] = 'Рейтинг';
$txt['karmaMode'] = 'Режим на рейтинга';
$txt['smf64'] = 'Деактивиран|Активиран сумарно|Активиран детайлно';
$txt['karmaMinPosts'] = 'Необходим минимален брой публикации';
$txt['karmaWaitTime'] = 'Изчакване в часове';
$txt['karmaTimeRestrictAdmins'] = 'Администраторите също да изчакват';
$txt['karmaLabel'] = 'Име на Рейтинга';
$txt['karmaApplaudLabel'] = 'Име на положителния рейтинг';
$txt['karmaSmiteLabel'] = 'Име на отрицателния рейтинг';

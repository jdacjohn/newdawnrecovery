...
$txt['smf154'] = ' آگے بڑھیں';
$txt['smf160'] = 'موڈیفیکیشن کی فائل کھولی جا چکی ہے لیکن اس موڈیفیکیشن کے ساتھ ایک پی ایچ پی اسکرپٹ  کی فائل موجود ہے جسکا  اس موڈیفیکیشن کے کام کرنے سے پہلے عمل میں لانا ضروری ہے۔  ';
$txt['smf161'] = 'چلے';
$txt['smf163'] = 'پڑھے';
$txt['smf173'] = 'سکرپٹ آؤٹ پٹ:';
$txt['smf174'] = 'مزید نوٹس';
$txt['smf175'] = 'ہدایت/ مزید نوٹس فائل';
$txt['smf180'] = 'پیکیج میں فائلوں کی فہرست';
$txt['smf181'] = 'آرچیو میں فائلیں';
$txt['smf182'] = 'پیکیج حاصل کرے';
$txt['smf183'] = 'پیکیجز سرور';
$txt['smf184'] = 'بروؤس';
$txt['smf185'] = 'سرور ڈالے';
$txt['smf186'] = 'سرور کا نام';
$txt['smf187'] = 'URL';
$txt['smf189'] = 'ابھی کوئی پیکیج نہیں۔';
$txt['smf190'] = 'ڈاؤنلوڈ';
$txt['smf192'] = 'پیکیج کامیابی سے ڈاؤنلوڈ ہو گیا';
$txt['smf193'] = 'پیکیج کامیابی سے ڈاؤنلوڈ ہو چکا ہے';
$txt['smf198'] = 'پیکیج مینیجر';
$txt['smf159b'] = 'موڈ ڈالیں';
...
$txt['smf163b'] = 'چلے';
$txt['smf174b'] = 'SQL کوائریز';
$txt['smf189b'] = 'ابھی کوئی موڈ انسٹال نہیں ہوا';
$txt['smf188b'] = 'Browse installed mods';
$txt['smf198b'] = 'ان انسٹال';
$txt['smf198d'] = 'موڈ فہرست ختم کرے';
$txt['smf198h'] = 'Sorry, you server has PHP set to SAFE MODE.  This feature is not compatible with SAFE MODE.  Sorry.';
$txt['smf198i'] = 'پھر بھی مجھے کوشش کرنے دو۔';

$txt['download_packages'] = ' پیکیج ڈاؤنلوڈ کرے';
$txt['installed_packages'] = 'Installed Packages';
$txt['package_settings'] = 'آپشنز';

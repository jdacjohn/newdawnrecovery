...
$txt['pm_labels_desc'] = 'You can add, edit and delete the labels used in your personal message centre from here.';
$txt['pm_label_add_new'] = 'Add New Label';
$txt['pm_label_name'] = 'Label Name';
$txt['pm_labels_no_exist'] = 'You have no labels set up at the moment!';
...
$txt['labels_too_many'] = 'Sorry, %s messages already had the maximum number of labels allowed!';
...
$txt['pm_report_desc'] = 'You can report the personal message you received to the admin team of the forum from here. Please be sure to include a description of why you are reporting the message as this will be sent along with the contents of the original message.';
$txt['pm_report_admins'] = 'Administrator to whom to send the report';
...
$txt['pm_report_pm_unedited_below'] = 'The original contents of the personal message which was reported are below:';
...
$txt['pm_search_choose_label'] = 'Choose labels for search or search all';

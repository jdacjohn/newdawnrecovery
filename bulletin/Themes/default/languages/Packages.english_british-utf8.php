...
$txt['smf198h'] = 'Sorry, your server has PHP set to SAFE MODE. This feature is not compatible with SAFE MODE.';
...
$txt['package_manager_desc'] = 'You can download and install modifications to your forum through an easy to use interface using the package manager.';
...
$txt['download_packages_desc'] = 'You can choose here to either download new packages from package servers or upload a package file directly to the forum.';
...
$txt['package41'] = 'The language pack has been extracted so you can now use it (by setting it in your settings).';
...
$txt['package_installed_done'] = 'The package was installed successfully.  You should now be able to use whatever functionality it adds or changes or be unable to use functionality it removes.';
...
$txt['packages_latest_fetch'] = 'Attempting to obtain the most popular and recent packages from www.simplemachines.org...';
...
$txt['package44'] = 'Installing this package will carry out the following actions:';
...
$txt['package_will_fail_warning'] = 'At least one error was encountered during a test installation of this package.
	...
	This error may be caused by a conflict between the package you are trying to install and another package you have already installed, an error in the package, a package which requires another package that you do not have installed yet or a package designed for another version of SMF.';
...
$txt['package_install_options_ftp_why'] = 'Using the package manager\'s FTP functionality is the easiest way to avoid having to manually chmod the files writeable through FTP yourself for the package manager to work.<br />Here you can set the default values for some fields.';
...
$txt['package_ftp_why'] = 'Some of the files the package manager needs to modify are not writeable. This needs to be changed by logging into FTP and using it to chmod or create the files and folders. Your FTP information may be temporarily cached for proper operation of the package manager.';
$txt['package_ftp_why_download'] = 'To download packages, the Packages directory and files in it need to be writeable which they are not currently.  The package manager can use your FTP information to fix this.';
...
$txt['package_upload_error_broken'] = 'The package you tried to upload is either not a valid package or has become corrupted.';
...
$txt['package_no_zlib'] = 'Sorry, your PHP configuration does not have support for <b>zlib</b>. The package manager cannot function without this. Please contact your host about this for more information.';

// Untranslated!
$txt['package_cleanperms_title'] = 'Cleanup Permissions';
$txt['package_cleanperms_desc'] = 'You can reset the permissions for files throughout your installation, using this interface, so as to increase security or solve any permission problems you may encounter while installing packages.';
$txt['package_cleanperms_type'] = 'Change all file permissions throughout the forum such that';
$txt['package_cleanperms_standard'] = 'Only the standard files are writeable.';
$txt['package_cleanperms_free'] = 'All files are writeable.';
$txt['package_cleanperms_restrictive'] = 'The minimum files are writeable.';

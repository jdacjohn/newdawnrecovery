...
$txt['go_to_your_forum'] = 'Je kunt <a href="%s">je zojuist ge&iuml;nstalleerde forum</a> bekijken en gebruiken. Je moet zijn ingelogd alvorens je het beheergedeelte kunt bekijken.';
...
$txt['default_theme_name'] = 'SMF Standaardthema (Core)';
...
$txt['install_settings_url'] = 'URL van het forum';
$txt['install_settings_url_info'] = 'Dit is de URL naar je forum <b>ZONDER de \'/\'!</b><br />In de meeste gevallen is de standaardwaarde juist.';
...
$txt['mysql_settings_info'] = 'Deze instellingen worden gebruikt voor de MySQL-server. Als je de gegevens niet weet, vraag deze dan aan je host of zoek ze op.';
...
$txt['mysql_settings_username_info'] = 'Vul hier de gebruikersnaam in die je nodig hebt om een verbinding te maken met de database.<br />Als je de gebruikersnaam niet weet, gebruik dan die van je FTP account, deze zijn veelal gelijk aan elkaar.';
$txt['mysql_settings_password'] = 'MySQL-wachtwoord';
$txt['mysql_settings_password_info'] = 'Vul hier het wachtwoord in dat je nodig hebt om een verbinding te maken met je database.<br />Als je het wachtwoord niet weet, gebruik dan die van je FTP account, deze zijn veelal gelijk aan elkaar.';
...
$txt['user_settings_email_info'] = 'Vul je e-mailadres in. <b>Dit moet een geldig e-mailadres zijn.</b>';
...
$txt['ftp_setup_info'] = 'Er kan een verbinding worden gemaakt via FTP om de bestanden die schrijfbaar moeten worden gemaakt als zodanig te CHMOD\'en. Als dit niet wekrt, zul je dit handmatig moeten doen met een FTP-programma. <b>Let op:</b> SSL wordt momenteel niet ondersteund.';
...
$txt['ftp_path_info'] = 'Dit is het <i>relatieve</i> pad dat je gebruikt in je FTP-server.';
...
$txt['ftp_setup_why_info'] = 'Sommige bestanden moeten schrijfbaar zijn om SMF goed te laten werken. Deze stap zal proberen de bestanden schrijfbaar te maken. In sommige gevallen zal dit echter niet werken - CHMOD in dat geval zelf de volgende bestanden 777 (schrijfbaar):';
...
$txt['error_session_save_path'] = 'Informeer je host dat de <b>session.save_path gespecificeerd in php.ini</b> niet juist is! Het moet worden aangepast naar een directory die <b>bestaat</b>, en <b>schrijfbaar</b> is voor de gebruiker waarop PHP draait.<br />';
$txt['error_windows_chmod'] = 'Je hebt een Windows-server, en enkele belangrijke bestanden zijn niet schrijfbaar. Vraag je host <b>schrijfpermissies</b> voor de bestanden bij de gebruiker waar PHP draait. De volgende bestanden of mappen moeten schrijfbaar zijn:';
...
$txt['error_mysql_too_low'] = 'De versie MySQL die wordt gebruikt is erg oud en voldoet niet aan de minimumeisen die SMF stelt.<br /><br />Vraag je host om een update of een nieuwe versie, en als ze dit niet willen, probeer dan een andere host.';
$txt['error_mysql_database'] = 'Kan geen verbinding maken met de &quot;<i>%s</i>&quot; database. Bij sommige hosts dien je een database te maken via een administratiepanel (cPanel / Manager) voordat SMF het kan gebruiken. Sommigen gebruiken ook prefixes - zoals je gebruikersnaam - bij de databasenaam.';
...
$txt['error_session_missing'] = 'Het installatieprogramma kon niet detecteren of sessies voor de PHP-installatie op deze server worden ondersteund. Vraag aan je provider om je te verzekeren van het feit dat PHP gecompileerd is met sessieondersteuning (in feite moet het sowieso expliciet worden gecompileerd).';
...
$txt['error_mysql_alter_priv'] = 'Het MySQL-account dat je opgaf heeft geen permissie om tabellen te wijzigen (ALTER), aan te maken (CREATE) en/of te verwijderen (DROP); deze permissies zijn noodzakelijk voor het juist functioneren van SMF.';
...
$txt['error_mod_security'] = 'De installatie heeft gedetecteerd dat de mod_security-module op je webserver is ge&iuml;nstalleerd. Mod_security blokkeert verstuurde formulieren zelfs voordat SMF er iets over kan zeggen. SMF heeft een ingebouwde veiligheidsscanner die effectiever is dan mod_security en die ingestuurde formulieren niet blokkeert. <br /><br /><a href="http://www.simplemachines.org/redirect/mod_security">Meer informatie over het uitschakelen van mod_security.</a>';
$txt['error_utf8_mysql_version'] = 'Helaas ondersteunt de huidige versie van je database het gebruik van de UTF-8 karakterset niet. Je kunt SMF zonder problemen installeren, alleen moet UTF-8-ondersteuning wel zijn uitgevinkt. Mocht je later alsnog op UTF-8 willen overgaan (bijvoorbeeld nadat de MySQL server is ge&uuml;pgrade naar een versie >= 4.1), dan kun je je forum via het beheerscherm converteren naar UTF-8.';

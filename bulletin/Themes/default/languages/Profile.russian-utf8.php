...
$txt['activate_reactivate_mail'] = 'Для подтверждения email адреса, Ваша учетная запись была деактивирована. Пожалуйста, пройдите по ссылке, чтобы заново ее активировать.';

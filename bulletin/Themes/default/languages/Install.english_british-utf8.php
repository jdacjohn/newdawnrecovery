...
$txt['congratulations_help'] = 'Please remember that <a href="http://www.simplemachines.org/community/index.php" target="_blank">help is available</a> if at any time you need support or SMF fails to work properly.';
$txt['still_writable'] = 'Your installation directory is still writeable.   For security reasons, it is a good idea to chmod it so that it is not writeable.';
$txt['delete_installer'] = 'Click here to delete this install.php file now.';
$txt['delete_installer_maybe'] = '<i>(does not work on all servers).</i>';
$txt['go_to_your_forum'] = 'Now you can see <a href="%s">your newly installed forum</a> and begin to use it.  You should first make sure you are logged in and then you will be able to access the administration centre.';
$txt['good_luck'] = 'Good luck!<br />Simple Machines';

$txt['user_refresh_install'] = 'Forum Refreshed';
$txt['user_refresh_install_desc'] = 'During installation using the details you provided, the installer found that one or more of the tables it might create already existed.<br />Any missing tables in your installation have been recreated with the default data but no data was deleted from existing tables.';
...
$txt['default_board_description'] = 'Feel free to talk about anything and everything on this board.';
...
$txt['install_settings_info'] = 'Just a few things for you to set up ;).';
...
$txt['install_settings_url_info'] = 'This is the URL to your forum <b>without the trailing \'/\'!</b>.<br />In most cases, you can leave the default value in this box alone as it is usually right.';
...
$txt['install_settings_stats_info'] = 'If enabled, this will allow Simple Machines to visit your site once a month to collect basic statistics which will help us make decisions on optimising the configurations of the software. For more information, please visit our <a href="http://www.simplemachines.org/about/stats.php" target="_blank">info page</a>.';
$txt['install_settings_proceed'] = 'Proceed';

$txt['mysql_settings'] = 'MySQL Server Settings';
$txt['mysql_settings_info'] = 'These are the settings to use for your MySQL server.  If you do not know the values, you should ask your host what they are.';
$txt['mysql_settings_server'] = 'MySQL server name';
$txt['mysql_settings_server_info'] = 'This is nearly always localhost so if you do not know, try localhost.';
$txt['mysql_settings_username'] = 'MySQL username';
$txt['mysql_settings_username_info'] = 'Enter the username you need to connect to your MySQL database here.<br />If you do not know what it is, try the username of your ftp account as most of the time they are the same.';
$txt['mysql_settings_password'] = 'MySQL password';
$txt['mysql_settings_password_info'] = 'Enter the password you need to connect to your MySQL database here.<br />If you do not know what it is, you should try the password to your FTP account.';
$txt['mysql_settings_database'] = 'MySQL database name';
$txt['mysql_settings_database_info'] = 'Enter the name of the database you want to use for SMF to store its data.<br />If this database does not exist, this installer will try to create it.';
...
$txt['user_settings_username_info'] = 'Choose the name you want to use to login.<br />This cannot be changed later but your display name can be.';
$txt['user_settings_password'] = 'Password';
$txt['user_settings_password_info'] = 'Enter your preferred password here and remember it well!';
$txt['user_settings_again'] = 'Password';
$txt['user_settings_again_info'] = '(just for verification).';
$txt['user_settings_email'] = 'Email Address';
$txt['user_settings_email_info'] = 'Enter your email address as well.  <b>This must be a valid email address.</b>';
$txt['user_settings_database'] = 'MySQL Database Password';
$txt['user_settings_database_info'] = 'To create an administrator account, the installer requires that you supply the database password for security reasons.';
$txt['user_settings_proceed'] = 'Finish';

$txt['ftp_setup'] = 'FTP Connection Information';
$txt['ftp_setup_info'] = 'This installer can connect via FTP to fix the files that are not currently writeable but need to be. You will have to manually make the files writeable if this does not work for you.  Note that SSL is not supported at the moment.';
$txt['ftp_server'] = 'Server';
$txt['ftp_server_info'] = 'This should be the server and port for your FTP server.';
$txt['ftp_port'] = 'Port';
$txt['ftp_username'] = 'Username';
$txt['ftp_username_info'] = 'The login username. <i>This will not be saved anywhere.</i>';
$txt['ftp_password'] = 'Password';
$txt['ftp_password_info'] = 'The login password. <i>This will not be saved anywhere.</i>';
...
$txt['ftp_setup_why'] = 'What is this step?';
$txt['ftp_setup_why_info'] = 'Some files need to be writeable for SMF to work properly.  This step allows you to let the installer make them writeable for you.  However, in some cases it will not work so in that case, please make the following files 777 (writeable, 755 on some hosts):';
$txt['ftp_setup_again'] = 'to test if these files are writeable again.';
...
$txt['error_session_save_path'] = 'Please inform your host that the <b>session.save_path specified in php.ini</b> is not valid!  It needs to be changed to a directory that <b>exists</b> and is <b>writeable</b> by the user under whom PHP is running.<br />';
$txt['error_windows_chmod'] = 'You are on a windows server and some crucial files are not writeable.  Please ask your host to give <b>write permissions</b> to the user under whom PHP is running for the files in your SMF installation.  The following files or directories need to be writeable:';
$txt['error_ftp_no_connect'] = 'Unable to connect to FTP server with this combination of details.';
$txt['error_mysql_connect'] = 'Cannot connect to the MySQL database server with the supplied data.<br /><br />Please contact your host if you are not sure about what to enter.';
$txt['error_mysql_too_low'] = 'The version of MySQL that your database server is using is very old and does not meet SMF\'s minimum requirements.<br /><br />Please ask your host to either upgrade it or supply a new one.  If they will not, please try a different host.';

...
$txt['permissions_access'] = 'Dostęp';
$txt['permissions_allowed'] = 'Zezw.';
$txt['permissions_denied'] = 'Pozb.';

$txt['permissions_switch'] = 'Przełącz na';
$txt['permissions_global'] = 'Globalne';
$txt['permissions_local'] = 'Lokalne';

$txt['permissions_groups'] = 'Zezwolenia wg grupy użytkowników';
...
$txt['permissions_deny_dangerous'] = 'Zamierzasz pozbawic grupe jedego lub kilku zezwolen.\\nTo moze byc niebezpieczne i spowodowac niepoczekiwane rezultaty jesli nie upewniles sie, ze nikt nie jest \\"przypadkowo\\" w grupie albo grupach, ktorych pozbawiasz zezwolen.\\n\\nNa pewno chcesz kontynuowac?';

$txt['permissions_boards'] = 'Zezwolenia wg działu';
...
$txt['permissions_modify_local'] = 'Modyfikuj zezwolenia lokalne';
...
$txt['permissionname_view_mlist'] = 'Przeglądanie listy użytkowników';
...
$txt['permissionname_admin_forum'] = 'Administracja forum i bazy danych';
...
$txt['permissionhelp_manage_smileys'] = 'Daje dostęp do centrum zarządzania uśmieszkami. Można tam dodawać, modyfikować i usuwać uśmieszki i zestawy uśmieszków.';
$txt['permissionname_edit_news'] = 'Modyfikacja aktualności';
...
$txt['permissionhelp_profile_title'] = 'Własny tytuł wyświetlanjy jest w wątku pod nazwami użytkowników, którzy go posiadają.';
...
$txt['permissionname_delete_replies'] = 'Usuwać odpowiedzi do własnych tematów';
...
$txt['permissionname_modify'] = 'Modyfikownie wiadomości';
...
$txt['permissionhelp_post_attachment'] = 'Załączniki to pliki doąłączane do wiadomości. Jedna wiadomość może zawierać kilka załączników.';
...
$txt['permission_by_membergroup_desc'] = 'Tutaj możesz ustawić uprawnienia globalne dla każdej z grup użytkowników. Te upranienia będą obowiązywać w każdym dziale, pod warunkiem, że ustawienia poszczególnych działów nie twierdzą inaczej. Ustawienia lokalne poszczególnych działów można ustawić na stronie \'Zezwolenia wg działu\'.';
...
// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
$txt['permission_disable_postgroups_warning'] = 'Wyłączenie tego ustawienia będzie oznaczać usunięcie uprawnień aktuanie przydzielonych grupom automatycznie przydzielanym według ilości wypowiedzi.';
$txt['permission_settings_enable_by_board'] = 'Włącz zaawansowane uprawnienia dla poszczególnych działów';
// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
$txt['permission_disable_by_board_warning'] = 'Wyłączenie tego ustawienia będzie oznaczać usunięcie wszystkich uprawnień ustawionych na poziomie działu';

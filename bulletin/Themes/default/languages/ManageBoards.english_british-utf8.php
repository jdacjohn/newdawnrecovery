...
$txt[677] = 'Edit your categories and boards here. List multiple moderators as <i>&quot;username&quot;, &quot;username&quot;</i> (these must be usernames not display names!).<br />Click the Add Board button to create a new board. Select "Child of..." from the Order drop-down menu when creating the board to make the new board a child of a current board.';
...
$txt['mboards_delete_cat_contains'] = 'Deleting this category will also delete the boards below it including all topics, posts and attachments within each board';
$txt['mboards_delete_option1'] = 'Delete category and all boards contained within it.';
$txt['mboards_delete_option2'] = 'Delete category and move all boards contained within it to';
$txt['mboards_delete_error'] = 'No category selected!';
$txt['mboards_delete_board_contains'] = 'Deleting this board will also move the child boards below it including all topics, posts and attachments within each board';
$txt['mboards_delete_board_option1'] = 'Delete board and move child boards contained within it to category level.';
$txt['mboards_delete_board_option2'] = 'Delete board and move all child boards contained within it to';
...
$txt['mboards_theme_desc'] = 'You can change the look of your forum inside only this board here.';
...
$txt['countChildPosts'] = 'Count child\'s posts in parents\' totals';

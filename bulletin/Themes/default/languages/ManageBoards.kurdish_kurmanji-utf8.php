...
$txt[41] = 'Forum û Kategoriyan sererast bike';
$txt[43] = 'Rêzkirin';
$txt[44] = 'Navê Tam';
...
$txt['catEdit'] = 'Kategoriyê sererast bike';
$txt['boardsEdit'] = 'Forumê sererast bike';
$txt['collapse_enable'] = 'Dikare biqermiçe';
$txt['collapse_desc'] = 'Destûr bide bikarhêneran ku kategoriyan biqermiçîne?';
...
$txt['mboards_new_cat'] = 'Kategoriyek nû';
$txt['mboards_new_board'] = 'Forumek nû';
$txt['mboards_new_cat_name'] = 'Kategoriya nû';
$txt['mboards_add_cat_button'] = 'Kategorî lê zêdeke';
$txt['mboards_new_board_name'] = 'Foruma nû';

$txt['mboards_name'] = 'Nav';
$txt['mboards_modify'] = 'biguherîne';
$txt['mboards_permissions'] = 'destûr';
// Don't use entities in the below string.
$txt['mboards_permissions_confirm'] = 'Are you sure you want to switch this board to use local permissions?';

$txt['mboards_delete_cat'] = 'Kategoriyê jê bibe';
$txt['mboards_delete_board'] = 'Forumê jê bibe';
...
$txt['mboards_delete_error'] = 'Tu kategorî nehaiye bijartin!';
...
$txt['mboards_delete_confirm'] = 'Temam';
$txt['mboards_delete_cancel'] = 'Betal';
...
$txt['mboards_cancel_moving'] = 'Veguheztinê betal bike';
$txt['mboards_move'] = 'veguheze';

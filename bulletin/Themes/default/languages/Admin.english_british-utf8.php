...
$txt[11] = 'A listing of all the members currently registered with your forum is shown below.';
$txt[65] = 'Next';
...
$txt[347] = 'You can change the basic settings for your forum from this page.  Be very careful with these settings as they may render the forum unusable.';
...
$txt[365] = 'Title BG Colour';
$txt[366] = 'Title Text Colour';
$txt[367] = 'Window BG Colour';
$txt[368] = 'Window BG Colour #2';
$txt[369] = 'Category BG Colour';
$txt[370] = 'Table Border Colour';
$txt[379] = 'Enable News';
$txt[380] = 'Enable Guest Posting?';
$txt[388] = 'News Fader Title Colour';
$txt[389] = 'News Fader News Colour';
...
$txt[644] = 'This is your &quot;' . $txt[208] . '&quot;.  You can edit settings, maintain your forum, view logs, install packages, manage themes and many other things from here.<div style="margin-top: 1ex;">If you have any trouble, please look at the &quot;Support and Credits&quot; page.  If the information there does not help you, feel free to <a href="http://www.simplemachines.org/community/index.php" target="_blank">look to us for help</a> with the problem.</div>You may also find answers to your questions or problems by clicking the <img src="' . $settings['images_url'] . '/helptopics.gif" alt="' . $txt[119] . '" title="' . $txt[119] . '" border="0" /> symbols for more information on the related functions.';
$txt[670] = 'Place one news item per box. Some BBC tags, such as <span title="Are you bold?">[b]</span>, <span title="I tal ics!!">[i]</span> and <span title="Brackets are great, no?">[u]</span>, are allowed in your news as well as smileys and HTML. Clear a news item\'s text box to remove it.';
$txt[684] = 'Forum Administrators';
$txt[699] = 'Reserved names will keep members from registering certain usernames or using these words in their displayed names. Choose the options you wish to use from below before submitting.';
...
$txt[735] = 'You can email anyone from here. The email addresses of the selected membergroups should appear below but you may remove or add any email addresses you wish. Be sure that each address is separated in this fashion: \'address1; address2\'.';
$txt[739] = 'Fading delay between items for the news fader:';
$txt[740] = 'Show BBC buttons on Posting and PM Send pages';

$txt['smf1'] = 'Failed to make backup of Settings.php. Make sure Settings_bak.php exists and is writeable.';
...
$txt['smf74'] = 'The following errors are causing problems on your forum';
...
$txt['smf202'] = 'You can administer the attached files on your system from here. You can delete attachments by size and by date from your system. Statistics on attachments are also displayed below.';
...
$txt['smf250'] = 'Please select the Membergroup(s) to which you would like to send an email.';
$txt['smf281'] = 'Optimise Database';
$txt['smf282'] = 'Your database contains %d tables.';
$txt['smf283'] = 'Attempting to optimise your database...';
$txt['smf284'] = 'Optimising %1$s... %2$f kb optimised.';
$txt['smf285'] = 'All of the tables were already optimised.';
$txt['smf285b'] = 'It was not necessary to optimise any tables.';
$txt['smf286'] = ' table(s) optimised.';
$txt['smf310'] = 'has a non-existent member ID';
$txt['smf319'] = 'Admin must approve all new members';
$txt['smf320'] = 'Warning - Agreement.txt is not writeable. Any changes you make will NOT be saved.';
...
$txt['lfyi'] = 'Unable to connect to simplemachines.org\'s latest news file.';
...
$txt['member_center_info'] = 'View the member list, search for members and manage not-yet-approved members or members who have not yet activated their account.';
...
$txt['email_variables'] = 'You can use a few &quot;variables&quot; in this message.  Click <a href="' . $scripturl . '?action=helpadmin;help=emailmembers" onclick="return reqWin(this.href);" class="help">here</a> for more information.';
...
$txt[724] = 'IP address banning: (e.g. 192.168.12.213 or 128.0.*.*) - one entry per line';
$txt[725] = 'Email address banning: (e.g. badguy@somewhere.com) - one entry per line';
$txt[7252] = 'User name banning: (e.g. l33tuser) - one entry per line';

$txt['ban_description'] = 'You can ban troublesome people by either IP address, hostname, username or email address from here.';
$txt['ban_add_new'] = 'Add new ban';
$txt['ban_banned_entity'] = 'Banned entity';
$txt['ban_on_ip'] = 'Ban on IP Address (e.g. 192.168.10-20.*)';
...
$txt['ban_add_notes'] = '<b>Note</b>: You can add additional entries that trigger the ban (like IP addresses, hostnames and email addresses) after creating the above ban.';
...
$txt['maintain_info'] = 'Optimise tables, make backups, check for errors and prune boards with these tools.';
...
$txt['maintain_optimize'] = 'Optimise all tables to improve performance.';
...
$txt['maintain_old_are_not_stickied'] = 'Do not count stickied topics.';
...
$txt['errlog2'] = 'The error log tracks every error encountered by your forum.  To delete errors from the database, mark the relevant checkbox and click the respective ' . $txt[31] . ' button.';
...
$txt['modlog_moderation_log_desc'] = 'A list of all the moderation actions that have been carried out by moderators of the forum is shown below.<br /><b>Note:</b> Entries cannot be removed from this log until they are at least twenty-four hours old.';
...
$txt['attachmentEncryptFilenames'] = 'Encrypt stored file names';
...
$txt['attachmentThumbWidth'] = 'Max width of thumbnails';
$txt['attachmentThumbHeight'] = 'Max height of thumbnails';
...
$txt['avatar_max_width_external'] = 'Max width of external avatar';
$txt['avatar_max_height_external'] = 'Max height of external avatar';
...
$txt['avatar_max_width_upload'] = 'Max width of uploaded avatar';
$txt['avatar_max_height_upload'] = 'Max height of uploaded avatar';
...
$txt['news_settings_desc'] = 'You can change the settings and permissions related to news and newsletters from here.';
$txt['news_settings_submit'] = 'Save';
$txt['news_mailing_desc'] = 'You can send messages to all members who have registered, and entered their email addresses, from this menu. You may edit the distribution list or send messages to all. Useful for important update/news information.';
...
$txt['update_message'] = 'You are using an outdated version of SMF which contains some bugs which have since been fixed.
...
$txt['manageposts_description'] = 'You can manage all settings related to topics and posts from here.';
...
$txt['manageposts_settings_description'] = 'You can set everything related to posts and posting from here.';
$txt['manageposts_settings_submit'] = 'Save';

$txt['manageposts_bbc_settings'] = 'Bulletin Board Code';
$txt['manageposts_bbc_settings_description'] = 'Bulletin Board Code can be used to add format to forum messages. For example, to highlight the word \'house\', you can type [b]house[/b]. All Bulletin Board Code tags are surrounded by square brackets (\'[\' and \']\').';
...
$txt['manageposts_topic_settings_description'] = 'You can set all settings involving topics from here.';
...
$txt['enableSpellChecking_warning'] = 'Does not work on all servers!';
...
$txt['spamWaitTime'] = 'Time required between posts from the same IP address';
...
$txt['not_done_reason'] = 'The process has been temporarily paused to avoid overloading your server but should automatically continue in a few seconds.  If it does not, click Continue below.';
...
$txt['utf8_introduction'] = 'UTF-8 is an international character set covering nearly all languages around the world. Converting your database and data to UTF-8 can make it easier to support multiple languages on the same board. It can also enhance search and sorting capabilities for languages with non-latin characters.';
$txt['utf8_warning'] = 'Be aware of the following if you want to convert your data and database to UTF-8:
<ul>
	...
	<li>UTF-8 is a richer character set than most other character sets so there is no way back except by restoring your database to before the conversion.</li>
	<li>You will need UTF-8 compatible language files after converting your data and database to UTF-8.</li>
</ul>';
...
$txt['copyright_removal_desc'] = 'You will need the code purchased from the Simple Machines website in order to remove the copyright from your SMF installation. If you have not yet purchased a code, click <a href="http://www.simplemachines.org/copyright/index.php">here</a>. Once the code has been entered and verified, the copyright will be hidden until your subscription expires. The time remaining will be shown on the admin centre.';
$txt['copyright_code'] = 'Copyright Code';
$txt['copyright_failed'] = 'Sorry, the code you entered is incorrect. Please ensure that your forum URL matches that entered when purchasing the subscription.';

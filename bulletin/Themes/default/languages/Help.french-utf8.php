...
$helptxt['allow_hideOnline'] = 'Avec cette option activ&eacute;e, tous les membres pourront cacher leur &eacute;tat de connexion au forum aux autres visiteurs (except&eacute; aux administrateurs). Si elle est d&eacute;sactiv&eacute;e, seuls les utilisateurs qui peuvent mod&eacute;rer le forum entier peuvent cacher leur pr&eacute;sence. Notez bien que d&eacute;sactiver cette option ne changera rien dans le statut des membres connect&eacute;s en ce moment - cela ne leur emp&eacute;chera la man&oelig;uvre que pour les futures connexions.';

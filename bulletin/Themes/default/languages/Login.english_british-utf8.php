...
$txt[37] = 'You must enter a username.';
$txt[38] = 'You have not entered your password.';
...
$txt[701] = 'You may change it after you login by going to the profile page or by visiting this page:';
...
$txt['register_immediate_message'] = 'You are now registered with an account at ' . $context['forum_name'] . ', %1$s!' . "\n\n" . 'Your account\'s username is %2$s and your password is %3$s.' . "\n\n" . 'You may change your password after you login by going to your profile or by visiting this page:' . "\n\n" . $scripturl . '?action=profile' . "\n\n" . $txt[130];
$txt['register_activate_message'] = 'You are now registered with an account at ' . $context['forum_name'] . ', %1$s!' . "\n\n" . 'Your account\'s username is %2$s and your password is %3$s (which can be changed later).' . "\n\n" . 'You first need to activate your account before you can login so please follow this link:' . "\n\n" . '%5$s' . "\n\n" . 'Please use the code "%4$s" if you have any problems with activation.' . "\n\n" . $txt[130];
$txt['register_pending_message'] = 'Your registration request at ' . $context['forum_name'] . ' has been received, %1$s.' . "\n\n" . 'The username with which you registered was %2$s and the password was %3$s.' . "\n\n" . 'Your request must be reviewed and approved before you can login and start using the forum and you will receive another email from this address after this has happened.' . "\n\n" . $txt[130];
...
$txt['activate_after_registration'] = 'Thank you for registering. You will receive an email soon with a link to activate your account.  If you do not receive an email after some time, check your spam folder.';
$txt['invalid_userid'] = 'User does not exist';
$txt['invalid_activation_code'] = 'Invalid activation code';
$txt['invalid_activation_username'] = 'Username or email address';
$txt['invalid_activation_new'] = 'If you registered with the wrong email address, enter a new one and your password here.';
...
$txt['invalid_activation_known'] = 'If you already know your activation code, please enter it here.';
...
$txt['change_password_2'] = 'have been changed and your password reset. Your new login details are shown below.';
...
$txt['admin_settings_desc'] = 'You can change a variety of settings here related to registration of new members.';
...
$txt['admin_setting_image_verification_nogd'] = '<b>Note:</b> This server does not have the GD library installed so the different complexity settings will have no effect.';

$txt['admin_setting_coppaAge'] = 'Age below which to apply registration restrictions';
$txt['admin_setting_coppaAge_desc'] = '(0 to disable)';
...
$txt['admin_setting_coppaPhone'] = 'Phone number for parents to contact with age restriction queries';
...
$txt['admin_register_desc'] = 'You can register new forum members here and, if desired, email them their details.';
...
$txt['admin_register_group_desc'] = 'Primary membergroup to which new member will belong';
...
$txt['admin_notify_approval'] = 'This member must first have their account approved before they can begin posting. Click the link below to go to the approval screen.';

$txt['coppa_title'] = 'Age Restricted Forum';
$txt['coppa_after_registration'] = 'Thank you for registering with ' . $context['forum_name'] . '.<br /><br />It is a legal requirement that we obtain your parent or guardian\'s permission before you may begin to use your account because you are under the age of {MINIMUM_AGE}. Please print off the form below to arrange for account activation.';

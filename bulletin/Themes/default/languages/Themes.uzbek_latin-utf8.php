...
$txt['theme_allow'] = 'Foydalanuvchilarga xohlagan temalarini tanlashga ruxsat berish.';
$txt['theme_default'] = 'Foydalanuvchilarga &quot;Default&quot; temasini tanlashga ruxsat berish.';
$txt['theme_guests'] = 'Overall forum default';
$txt['theme_select'] = 'Tanlash...';
$txt['theme_reset'] = 'Reset everyone to';
$txt['theme_nochange'] = 'O`zgarishsiz';
$txt['theme_forum_default'] = 'Forum Default';

$txt['theme_settings'] = 'Menyular';
$txt['theme_remove'] = 'Olib tashlamoq';
$txt['theme_remove_confirm'] = 'Are you sure you want to permanently remove this theme?';

$txt['theme_install'] = 'Yamgi tema o`rnatish';
$txt['theme_install_file'] = 'Fayllarda olish';
...
$txt['theme_install_go'] = 'O`rnat!';
$txt['theme_install_new'] = 'Create a copy of Default named';
$txt['theme_install_new_confirm'] = 'Yangi tema o`rnatilsinmi?';
...
$txt['theme_installed'] = 'O`rnatildi';
$txt['theme_installed_message'] = 'O`rnatildi.';

$txt['theme_latest'] = 'So`nggi va eng yaxshi temalar';
$txt['theme_latest_fetch'] = 'Fetching latest themes from www.simplemachines.org...';

$txt['theme_pick'] = 'Tema tanlash...';
$txt['theme_preview'] = 'preview &raquo;';
$txt['theme_set'] = 'Ushbu temadan foydalanish';
$txt['theme_user'] = 'Bu temadan foydalanilyapti';
$txt['theme_users'] = 'Bu temadan foydalanishyapti.';

$txt['theme_edit'] = 'Temadan foydalanish';
...
$txt['theme_edit_save'] = 'O`zgarishlarni saqlash';
...
$txt['who_display_viewing_off'] = 'Ko`rsatmang';
$txt['who_display_viewing_numbers'] = 'Faqat raqmlarni ko`rsating';
$txt['who_display_viewing_names'] = 'Foydalanuvchilar ismini ko`rsating';

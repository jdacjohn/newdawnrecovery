...
$helptxt['number_format'] = '<b>Formato de N&uacute;meros</b><br />
	...
	Donde \',\' es el car&aacute;cter utilizado para dividir los grupos de miles, \'.\' es el caracter utilizado como el punto decimal y el n&uacute;mero de ceros indica la exactit&uacute;d de los redondeos.';
...
$helptxt['serversettings'] = '<b>Configuraci&oacute;n del Servidor</b><br />
	Aqu&iacute; puedes realizar la configuraci&oacute;n principal de tu foro. Esta secci&oacute;n incluye la configuraci&oacute;n de la base de datos y URLs, as&iacute; como otros elementos importantes de la configuraci&oacute;n como la configuraci&oacute;n del correo y el cach&eacute;s. S&eacute; cuidadoso al editar estas configuraciones porque un error podr&iacute;a dejar inaccesible el foro';
...
$helptxt['compactTopicPagesEnable'] = 'Esto mostrar&aacute; una selecci&oacute;n del n&uacute;mero de las p&aacute;ginas.<br /><i>Ej.:</i>
...
$helptxt['attachmentEnable'] = 'Los archivos adjuntos son archivos que los usuarios pueden subir, y adjuntar a un mensaje.<br /><br />
		...
		<b>Ajustar el tama&ntilde;o de las im&aacute;genes cuando se muestren debajo de los mensajes</b>:<br /> Si la opci&oacute;n anterior fue seleccionada, esto guardar&aacute; un attachment separado (mas peque&ntilde;o) para la vista miniatura para ahorrar ancho de banda.<br />
		<b>Ancho y Alto m&aacute;ximos de las vistas miniaturas</b>:<br /> Usado solamente con la opci&oacute;n &quot;Ajustar el tama&ntilde;o de las im&aacute;genes cuando se muestren debajo de los mensajes&quot;, el ancho y alto m&aacute;ximos al que se le reducir&aacute;n el tama&ntilde;o a las im&aacute;gen. Se les cambiar&acute; el tama&ntilde;o proporcionalmente.';
...
$helptxt['emailmembers'] = 'En este mensaje puedes usar algunas &quot;variables&quot;.  &Eacute;stas son:<br />
	...
	{$member.email} - El correo electr&oacute;nico del usuario destino.<br />
...
$helptxt['countChildPosts'] = 'Al marcar esta opci&oacute;n, todos los mensajes y temas de un foro hijo contar&aacute;n en los totales del foro.<br /><br />Esto har&aacute; las cosas considerablemente m&aacute;s lentas, pero significa que un padre sin mensajes no mostrar&aacute; \'0\'.';
...
$helptxt['max_pm_recipients'] = 'Esta opci&oacute;n te permite especificar el m&aacute;ximo de destinatarios permitidos en un un mensaje privado enviado por un usuario. Esto puede ser usado para ayudar a evitar el abuso por spam de tu sistema de mensajes privados. Toma en cuenta que los usuarios con permiso para enviar boletines de noticias est&aacute;n exentos de esta restricci&oacute;n. Establece el valor en cero para que no haya l&iacute;mite.';
$helptxt['pm_posts_verification'] = 'Esta opci&oacute;n forzar&aacute; a los usuarios a introducir un c&oacute;digo que ser&aacute; mostrado en una imagen de verificaci&oacute;n cada vez que ellos env&iacute;en un mensaje privado. Solamente los usuarios con un numero de mensajes publicados menor al n&uacute;mero especificado tendr&aacute;n que introducir el c&oacute;digo - esto debe ayudar para combatir los scripts autom&aacute;ticos de spam.';
$helptxt['pm_posts_per_hour'] = 'Esta opci&oacute;n limitar&aacute; el n&uacute;mero de mensajes privados que pueden ser enviados por un usuario en una hora. Esto no afecta a los administradores o moderadores.';
	...
	<ul>
		<li>
			...
			<b>Registro Inmediato</b><br />
				Los nuevos usuarios pueden ingresar y publicar inmediatamente despu&eacute;s de registrarse en tu foro.<br />
		</li><li>
			<b>Activaci&oacute;n de Usuario</b><br />
				Cuando esta opci&oacute;n est&aacute; activada cualquier usuario que se registre en tu foro tendr&aacute; un enlace de activaci&oacute;n, que se le enviar&aacute; por email, que tendr&aacute; que visitar antes de que pueda convertirse en usuario v&aacute;lido.<br />
		</li><li>
...
$helptxt['password_strength'] = 'Esta opci&oacute;n determina el grado de robustez requerida para las contrase&ntlde;as seleccionadas por los usuarios de tu foro. Cuanto m&aacute;s &quot;robusta&quot; sea la contrase&ntilde;a, m&aacute;s dif&iacute;cil es comprometer las cuentas de los usuarios.
...
$helptxt['coppaType'] = 'Si las restricciones de edad est&aacute;n activas, entonces este valor determinar&aacute; qu&eacute; pasar&aacute; cuando un usuario m&aacute;s joven de la edad m&iacute;nima intenta registrarse en tu foro. Hay dos posibilidades:
	<ul>
		<li>
			...
			<b>Requerir aprobaci&oacute;n del Padre o Tutor</b><br />
...
$helptxt['permissions_deny'] = 'Denegar permisos puede ser &uacute;til cuando quieres quitar permisos de algunos usuarios. Puedes a&ntilde;adir un grupo con permiso \'denegado\' a los usuarios que deseas denegar un permiso.<br /><br />Util&iacute;zalos con cuidado, un permiso denegado prevalece, no importa a que otros grupos pertenezca el usuario.';
...
$helptxt['search_weight_sticky'] = 'Los factores de peso se usan para determinar la relevancia de los resultados de la b&uacute;squeda. Cambia estos factores de peso para que coincida con las cosas que son importantes especificamente para tu foro. Por ejemplo, un foro de un sitio de noticias, puede necesitar un valor relativamente alto para \'antig&uuml;edad del &uacuteltimo mensaje que coincidi&oacute;\'. Todos los valores son relativos, relacionados entre s&iacute;, y deben ser enteros positivos.<br /><br />Este factor revisa si un tema ha sido fijado, y de ser as&iacute; incrementa la puntuaci&oacute;n.';
...
$helptxt['search_why_use_index'] = 'Un &iacute;ndice de b&uacute;squeda puede mejorar considerablemente el desempe&ntilde;o de las b&uacute;squedas en tu foro. Especialmente cuando el n&uacute;mero de mensajes en tu foro crece considerablemente, el buscar sin un &iacute;ndice puede tomar mucho tiempo e incrementar la carga en tu servidor. Si tu foro tiene m&aacute;s de 50,000 mensajes, debes considerar el crear el &iacute;ndice de b&uacute;squeda para asegurar un desempe&ntilde;o &oacute;ptimo de tu foro.<br /><br />Es importante mencionar que un &iacute;ndice de b&uacute;squeda puede tomar alg&uacute;n espacio extra de la base de datos. Un &iacute;ndice fulltext es un tipo de &iacute;ndice dentro de MySQL. Es relativamente compacto (aproximadamente el mismo tama&ntilde;o de la tabla de mensajes), pero muchas palabras no son indexadas y puede, en algunas b&uacute;squedas, ser muy lento. El &iacute;ndice personalizado usualmente necesita mayor espacio (dependiendo de tu configuraci&oacute;n puede ser hasta 3 veces mayor a tu tabla de mensajes) pero su desempe&ntilde;o es mejor que fulltext y mucho mas estable.';

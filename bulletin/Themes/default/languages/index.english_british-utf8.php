...
$txt[311] = 'to';
$txt[315] = 'Forgotten your password?';
...
$txt['participation_caption'] = 'Topic in which you have posted';
...
$txt[683] = 'I am a geek!!';
$txt[685] = $context['forum_name'] . ' - Info Centre';
...
$txt['sendtopic_this_topic'] = 'I want you to check out "%s" on ' . $context['forum_name'] . '.  Please click this link to view it.';
...
$txt[1004] = 'Line';
// Use numeric entities in the below string.
$txt[1005] = 'SMF has detected, and automatically tried to repair, an error in your database.  Please contact your host if you continue to have problems or continue to receive these emails.';
...
$txt['template_parse_error_message'] = 'Something seems to have gone wrong with the template system on the forum.  This problem should only be temporary so please come back later and try again.  Please contact the administrator if you continue to see this message.<br /><br />You can also try <a href="javascript:location.reload();">refreshing this page</a>.';
$txt['template_parse_error_details'] = 'There was a problem loading the <tt><b>%1$s</b></tt> template or language file. Please check the syntax and try again. Remember, single quotes (<tt>\'</tt>) often have to be escaped with a slash (<tt>\\</tt>). Try <a href="' . $boardurl . '%1$s">accessing the file directly</a> to see more specific error information from PHP.<br /><br />You may want to try to <a href="javascript:location.reload();">refresh this page</a> or <a href="' . $scripturl . '?theme=1">use the default theme</a>.';
...
$txt['smf25'] = 'Shortcuts: Alt+s to submit/post or Alt+p to preview';
...
$txt['smf60'] = 'Sorry, you do not have enough posts to modify karma. You need at least ';
$txt['smf62'] = 'Sorry, you cannot repeat a karma action without waiting ';
$txt['smf82'] = 'Board';
$txt['smf88'] = 'in';
...
$txt['smf315'] = 'Use this function to inform the moderators and administrators of an abusive or wrongly posted message.<br /><i>Note that your email address will be revealed to the moderators if you use this function.</i>';
...
$txt['tables_optimized'] = 'Database tables optimised';
...
$txt['change_color'] = 'Change Colour';
...
$txt['ssi_not_direct'] = 'Please do not access SSI.php by URL directly. You may want to use the path (%s) or add ?ssi_function=something.';
$txt['ssi_session_broken'] = 'SSI.php was unable to load a session!  This may cause problems with logout and other functions.  Make sure SSI.php is included before *anything* else in all your scripts!';

// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
$txt['preview_title'] = 'Preview post';
$txt['preview_fetch'] = 'Obtaining preview...';

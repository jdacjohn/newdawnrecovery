...
$txt['admin_setting_image_verification_type'] = 'Complexit&eacute; de l\'image de v&eacute;rification visuelle';
$txt['admin_setting_image_verification_type_desc'] = 'Plus l\'image est complexe plus les bots auront du mal &agrave; contourner le syst&egrave;me';
$txt['admin_setting_image_verification_off'] = 'D&eacute;sactiv&eacute;';
$txt['admin_setting_image_verification_vsimple'] = 'Tr&egrave;s simple - Image en texte plein';
$txt['admin_setting_image_verification_simple'] = 'Simple - Lettres aur&eacute;ol&eacute;es de couleur, pas de son';
$txt['admin_setting_image_verification_medium'] = 'Moyen - Lettres aur&eacute;ol&eacute;es de couleur, avec son';
$txt['admin_setting_image_verification_high'] = 'Haut - Lettres angulaires, avec &eacute;norm&eacute;ment de son';
$txt['admin_setting_image_verification_sample'] = 'Echantillon';
$txt['admin_setting_image_verification_nogd'] = '<b>Note:</b> Comme ce serveur n\'a pas la librairie GD d\'install&eacute;e les diff&eacute;rents r&eacute;glages de complexit&eacute; n\'auront aucun effet.';

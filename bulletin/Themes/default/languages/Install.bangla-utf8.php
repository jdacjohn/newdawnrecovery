...
$txt['smf_installer'] = 'SMF ইন্সটল';
$txt['installer_language'] = 'ভাষা';
$txt['installer_language_set'] = 'বসান';
$txt['congratulations'] = 'SMF ইন্সটল হয়েছে!';
$txt['congratulations_help'] = 'যদি আপনার সাহায্য লাগে, অথবা SMF কাজ না করে, তাহলে মনে রাখবেন যে <a href="http://www.simplemachines.org/community/index.php" target="_blank">এখানে সাহায্য পাবেন</a>।';
$txt['still_writable'] = 'আপনার ইন্সটল ডাইরেক্টরিতে এখন পর্যন্ত লেখা যাবে। এটাতে না লেখতে পারলে ভালো হবে।';
$txt['delete_installer'] = 'এখানে ক্লিক করুন install.php ফাইল বাদ দিতে।';
$txt['delete_installer_maybe'] = '<i>(সব server-এ কাজ করে না।)</i>';
$txt['go_to_your_forum'] = 'এখন দেখতে পারবেন <a href="%s">আপনার বানানো ফোরাম</a> এবং ব্যবহার করতে শুরু করুন। আপনি প্রবেশ করে দেখুন আপনি প্রশাসকের কেন্দ্রে ঢুকতে পারছেন কিনা।';

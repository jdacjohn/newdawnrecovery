...
$txt[189] = 'Choose a board in which to search or search all';
...
$txt['search_settings_desc'] = 'You can change the basic settings of the search function from here.';
$txt['search_settings_title'] = 'Search function - settings';
$txt['search_settings_save'] = 'Save';

$txt['search_weights'] = 'Weights';
$txt['search_weights_desc'] = 'You can change the individual components of the relevance rating from here. ';
...
$txt['search_method_desc'] = 'You can set the way the search is powered from here.';
...
$txt['search_method_no_index_exists'] = 'does not currently exist';
$txt['search_method_fulltext_create'] = 'create a fulltext index';
$txt['search_method_fulltext_cannot_create'] = 'cannot be created because the maximum message length is above 65,535 or table type is not MyISAM';
...
$txt['search_method_fulltext_warning'] = 'You will have to create a fulltext index first in order to be able to use fulltext search.';
...
// This string is used in a javascript confirmation popup; don't use entities.
$txt['search_index_custom_warning'] = 'You will have to create a custom index first in order to be able to use a custom index search.';
...
$txt['search_create_index_not_ready'] = 'SMF is currently creating a search index of your messages. The process has been temporarily paused to avoid overloading your server and should automatically continue in a few seconds. If it does not, click Continue below.';
...
$txt['search_double_index'] = 'You have currently created two indexes on the messages table. It is advisable to remove one of the two indexes for best performance.';

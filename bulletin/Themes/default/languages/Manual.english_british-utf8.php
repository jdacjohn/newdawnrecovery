...
$txt['manual_index_you_have_arrived_part1'] = 'So, you have arrived at this ';
$txt['manual_index_you_have_arrived_link_site0'] = 'Simple Machines Forum';
$txt['manual_index_you_have_arrived_part2'] = ' (SMF)! Perhaps you have been looking at the ';
$txt['manual_index_you_have_arrived_link_site0_board'] = 'board index';
$txt['manual_index_you_have_arrived_part3'] = ' or a screen telling you that you need to register before you can read it and you are wondering what to do next?';
$txt['manual_index_guest_permit_read_part1'] = 'Well, some forums permit guests to read and post, some permit guests to read only and some are restricted to registered members. We would recommend ';
$txt['manual_index_guest_permit_read_link_registering'] = 'registering';
$txt['manual_index_guest_permit_read_part2'] = ' at any forum that you see yourself using regularly because many of the most useful features will only become available to you when you do so. Since SMF, however, is such a flexible system that few forums are likely to be identical, we will start by describing four key areas that we would normally expect to be there for you.';
$txt['manual_index_main_menu'] = 'The Main Menu';
$txt['manual_index_suppossing_guest'] = 'Supposing you have arrived here as a guest (or have registered but are currently logged out), the main menu (which appears on every page) should normally comprise five or six buttons (or text links).';
...
$txt['manual_index_search_desc_part2'] = ' the forums for whatever want.';
...
$txt['manual_index_once_registered'] = 'Once you have registered and logged in, however, the main menu should look a little different.';
...
$txt['manual_index_sec_board_index_def'] = 'The board index (forum home page) is packed with all kinds of information and links. However, the core of the interface (at least in the SMF default theme) normally looks something like this.';
...
$txt['manual_index_normal_post'] = 'Topic in which you have posted';
...
$txt['manual_index_topic_text'] = 'The text of the message is here, which is ultimately why we are all here!';
...
$txt['manual_index_page_no_link'] = 'The <strong>page numbers</strong> link to further pages of the topic may be accompanied by <strong>Go Up</strong> and <strong>Go Down</strong> buttons linking to the top and bottom of the current page.';
...
$txt['manual_index_author_details'] = 'The <strong>author details</strong> in the left hand column may be accompanied by further personal information.';
...
$txt['manual_index_logged_IP'] = '<strong>Logged</strong> indicates that the IP address of the author has been logged. The actual IP address is only available to board administrators.';
$txt['manual_index_jump_to_menu_provides'] = 'The <strong>Jump to</strong> menu provides a conveniently quick method of navigating the forum.';
...
$txt['manual_loginout_login_desc'] = 'So, you might be newly registered or you might simply have been logged out from a previous visit. In either case, there is normally a choice between the login screen and the quick login.';
...
$txt['manual_loginout_login_screen_desc_part2'] = ') is not only where you will normally be taken on completing registration but also the first thing you will see in any \'members only\' forum, we will describe it first.';
...
$txt['manual_loginout_forgot'] = 'Forgotten your password';
$txt['manual_loginout_login_screen_explanation'] = 'The <strong>Username</strong> and <strong>Password</strong> fields should be self-explanatory. <strong>Minutes to stay logged in</strong> simply means the number of minutes the cookie that keeps you logged in will last before expiring and requiring you to login again. It is not advisable to enter a long time here if you share a computer and are likely to forget to logout. However, you might prefer to check <strong>Always stay logged in</strong> if no-one else has access to your computer.';
$txt['manual_loginout_sub_quick_login'] = 'The Quick Login';
$txt['manual_loginout_although_many_forums_part1'] = 'Many forums also have a quick login box to allow you to login directly from any screen but its position on the page may vary considerably from forum to forum. In the SMF default theme, for example, it is in the collapsable section at the top whereas it is more likely to be at the bottom in themes based on the older YaBB SE forum. If you cannot see it and it has not simply been collapsed, it is either not enabled at all (in which case you should still be able to access the login screen from the ';
$txt['manual_loginout_although_many_forums_link_index_main'] = 'main menu';
$txt['manual_loginout_although_many_forums_part2'] = ') or you are already logged in (in which case the main menu should include a <strong>Logout</strong> rather than <strong>Login</strong> link!).';
...
$txt['manual_loginout_reminder_desc_part1'] = 'If you are trying to login to the forum but have forgotten or lost your password, you can retrieve it with the lost password tool by following the <strong>Forgotten your password?</strong> link from the ';
...
$txt['manual_loginout_username_email'] = 'Username/email address';
...
$txt['manual_loginout_q_explanation'] = 'You cannot retrieve your password but you can set a new one by following a link sent to you by email.  You also have the option of setting a new password by answering your secret question.';
$txt['manual_loginout_reminder_explanation'] = 'You can enter either your username or your email address, so long as you check the appropriate option, then click the <strong>Send</strong> button to send yourself an email containing a link to reset your password. It is also possible to avoid the email altogether if you have set yourself a secret question and answer in your profile but please beware of questions that anyone could answer or guess (like \'what is the first colour of the rainbow?\' which would be a very bad choice)!';

// Entries for template: pm.
$txt['manual_pm_community'] = 'SMF is about community and communication. There are many ways to communicate such as posting to the boards, personal messaging, email, ICQ, AIM and YIM. However, SMF\'s own personal message system, available to registered members in most forums, is sometimes a more suitable option than any of these.';
$txt['manual_pm_sec_pm'] = 'Personal Messaging';
$txt['manual_pm_pm_desc'] = 'Description';
$txt['manual_pm_pm_desc_1'] = 'Email is a good way to correspond directly with members but it also has several drawbacks for forum purposes. You must open your email application to write and send the message, the recipient must open his/her email application and check his/her mail, your message will be mixed in with all the other mail and it can sometimes take several minutes to an hour for mail to reach the recipient.';
$txt['manual_pm_pm_desc_2'] = 'As an alternative to email, SMF offers a faster, more private method. Personal messaging on the boards provides instantaneous delivery to the recipient\'s private mailbox. The mail is sent and received entirely through SMF so neither you nor the recipient has to open another program or leave SMF. Personal messaging also offers both the sender and the recipient greater privacy because no-one\'s real email address is revealed. Personal messages show only the handle and name of both parties.';
$txt['manual_pm_pm_desc_3'] = 'If a recipient is not online, personal messages wait in the member\'s PM box until the next time he/she logs in and reads and/or deletes them. SMF Personal Messages is a self-contained, highly private email system.';
$txt['manual_pm_reading'] = 'Reading Your Messages';
$txt['manual_pm_reading_desc_part1'] = 'You need to be ';
$txt['manual_pm_reading_desc_link_loginout'] = 'logged in';
$txt['manual_pm_reading_desc_part2'] = ' to read your personal messages then follow the link that says something like \'Hey, [username], you have ';
...
$txt['manual_pm_pm_desc2_part2'] = '. We are showing the inbox interface here but the outbox works in much the same way.';
...
$txt['manual_pm_delete_button'] = 'The <strong>Delete Selected</strong> button deletes messages in your inbox (or outbox if open). Note that the top checkbox selects all messages for deletion while the lower checkbox allows you to delete selected messages.';
$txt['manual_pm_outbox_button'] = 'The <strong>Inbox</strong> and <strong>Outbox</strong> buttons select your inbox and outbox respectively.';
...
$txt['manual_pm_click_im_icon'] = 'You can start a new message directly by clicking the <strong>IM on/offline</strong> icon from the user info accompanying all of his/her posts.';
$txt['manual_pm_click_pm_icon_part1'] = 'You can start a new message directly by clicking the <strong>PM on/offline</strong> icon from the <strong>Current Status</strong> in his/her ';
...
$txt['manual_posting_forum_about_part1'] = 'Posting messages is basically what forums are all about so we will spend some time looking at the various options and techniques available. Those who are familiar with forum software, HTML or Bulletin Board Code in general may prefer to skip straight to the ';
...
$txt['manual_posting_please_note'] = '<strong>Note that because an SMF forum may be customised extensively by its administrator(s), the presence of a feature in this documentation does not necessarily mean that it will be available to all users in all forums.</strong>';
...
$txt['manual_posting_starting_topic_desc_part2'] = ') which should take you to the <strong>Start new topic</strong> screen. This presents a number of options but the two most important are the <strong>Subject</strong> field and main <strong>Message</strong> field (not labeled as such but obvious by its size). Enter your subject and start to type (or paste) your message into the main text area. Note that a message missing either a subject or a body will not be accepted for posting until it has both. If you are happy with your plain text message, you can then post it by clicking the <strong>Post</strong> button and/or preview it first by clicking the <strong>Preview</strong> button. However, there are many further ';
...
$txt['manual_posting_shortcuts'] = 'Shortcuts: Alt+s to submit/post or Alt+p to preview';
...
$txt['manual_posting_event_desc_part1'] = 'Where this option has been configured (it is not standard \'out of the box\'), you can post an event by selecting <strong>Calendar</strong> from the ';
...
$txt['manual_posting_replying_desc_part2'] = ' but it is not necessary to enter anything in the <strong>Subject</strong> field unless you wish to change what is already there. To vote in a poll, you simply have to select your chosen option(s) and click <strong>Submit Vote</strong>.';
$txt['manual_posting_quick_reply_part1'] = 'If \'Quick Reply\' has been enabled, a simple reply field will also appear after the post(s) on a page but you will have to type your ';
...
$txt['manual_posting_quick_reply_part3'] = ' manually if you choose to use them.';
$txt['manual_posting_quote_post'] = 'Quoting a Post';
$txt['manual_posting_quote_desc'] = 'To reply to a post by quoting it, you can either click the <strong>Quote</strong> button for the relevant post and add your own message to the quoted text or click the <strong>Reply</strong> button followed by <strong>Insert Quote</strong> from the relevant post in the \'Topic Summary\' below. Note that:';
...
$txt['manual_posting_italicize_example'] = 'Italicised';
...
$txt['manual_posting_center_example'] = 'Centred';
...
$txt['manual_posting_email_example'] = 'Insert Email Address';
...
$txt['manual_posting_Change_Color'] = 'Change Colour';
...
$txt['manual_posting_bbc_desc'] = 'Bulletin Board Code (or BBC) is the essential tool for formatting and changing the appearance of your post. The codes affect the plain text in much the same way as the formatting tools in any word processor however the main <strong>Message</strong> field does not behave in a WYSIWYG manner so you should preview your message if you need to see what it will look like when posted.';
...
$txt['manual_posting_smiley_desc_part1'] = 'Smileys can be viewed as purely whimsical in nature. However, they can also play a valuable role in clarifying the written word in much the same way as vocal inflections and/or facial expressions clarify the spoken word. Like most forum software, SMF provides a standard range of smiley images which can be added to posts by clicking the relevant icons or typing the relevant codes. A ';
$txt['manual_posting_smiley_desc_link_nosmileys'] = 'do not use smileys';
$txt['manual_posting_smiley_desc_part2'] = ' option is also provided for those occasions when you do not want typed character combinations that would normally be displayed as smileys to be converted to the expected images!';
...
$txt['manual_posting_tags_desc_part2'] = ' and their purposes, let us see how they work by imagining that we want to post some text in bold type. We could start by clicking the <strong>B</strong> (Bold) button and typing our text between the tags it produces but it is often more practical to type the text first, highlight it and then click the button. So typing \'text\', highlighting it and clicking the \'B\' button should produce \'[b]text[/b]\' which renders as <b>text</b> when posted or previewed (Note: This does not work in Opera which inserts the tags at the end of the post). Subsequently highlighting \'[b]text[/b]\' and clicking the <strong>I</strong> (Italicized) button will produce \'[i][b]text[/b][/i]\' which not only renders as <i><b>text</b></i> when posted or previewed but also introduces the concept of nesting. Nesting means that each new set of tags in a case like this should be seen as a new \'box\' containing both the original text <em>and</em> any tags already applied to it.';
$txt['manual_posting_note_tags'] = 'Note that the BBC tags can also be typed and edited directly instead of clicking the buttons.';
$txt['manual_posting_sec_additional_options'] = 'Additional Options';
$txt['manual_posting_sec_additional_options_desc'] = 'The following options may appear by default in some forums but be contained within an expanding/collapsing panel (try clicking the link below!) in others.';
$txt['manual_posting_notify'] = 'Notify me of replies';
$txt['manual_posting_return'] = 'Return to this topic';
$txt['manual_posting_no_smiley'] = 'Do not use smileys';
...
$txt['manual_posting_return_desc'] = 'Check this to return to the topic (instead of the message index) after posting (Note: You can also set this behavior as a preference in your profile).';
$txt['manual_posting_sub_no_smiley'] = 'Do not use smileys';
...
$txt['manual_posting_attach_desc_part2'] = ' but note that:';
$txt['manual_posting_attach_desc2'] = 'The permitted file types and sizes are set by the forum administrator(s).';
$txt['manual_posting_most_forums_attach'] = 'Most forums are likely be configured to display attached images as part of the post however it is not possible to <em>preview</em> attachments so you should always browse to, and attach, your files just before you finally <em>post</em> your message.';
...
$txt['manual_posting_bbc_italic'] = 'Italicised';
$txt['manual_posting_italic_code'] = '[i]italicised[/i]';
$txt['manual_posting_italic_output'] = 'italicised';
...
$txt['manual_posting_glow_comment'] = 'The three attributes (eg red, 2, 50) in the \'glow\' tag are colour, strength and width respectively.';
...
$txt['manual_posting_shadow_comment'] = 'The two attributes (eg red, left) in the \'shadow\' tag are colour and direction respectively.';
...
$txt['manual_posting_bbc_centered'] = 'Centred';
$txt['manual_posting_centered_code'] = '[center]Centred[/center]';
$txt['manual_posting_centered_output'] = 'Centred';
...
$txt['manual_posting_bbc_color'] = 'Font Colour';
$txt['manual_posting_color_code'] = '[color=Red]red[/color]';
$txt['manual_posting_color_output'] = 'red';
$txt['manual_posting_color_comment'] = 'Select the colour from the drop-down.';
...
$txt['manual_posting_flash_comment'] = 'Note that if embedded Flash has been disabled by the forum administrator(s), the Flash file will appear as a straight hyperlink as shown here. The two attributes in the \'flash\' tag (where relevant) are width and height respectively.';
...
$txt['manual_posting_url_comment'] = 'Note: The \'url\' tag opens in a new window but you can type \'iurl\' tags to open in the same window.';
...
$txt['manual_posting_bbc_email'] = 'Insert Email Address';
...
$txt['manual_posting_column_comment'] = 'Note the correct nesting of the tags. The \'table\' tags contain the \'tr\' tags which each contain an equal number of \'td\' tags!';
...
$txt['manual_posting_list_comment'] = 'You can add as many items as you wish but each item must be contained by the correct opening and closing tags. You could also style your list item bullets with special opening tags and no closing tags but this option does not currently output valid XHTML.';
...
$txt['manual_posting_smiley_parse'] = 'Note that not all of the smiley codes will be correctly parsed and converted to images unless their opening spaces are present.';

// Entries for template: profile.
$txt['manual_profile_profile_screen'] = 'The profile screen in the default theme normally consists of a single main pane with an additional menu to the left to lead you through the editing options for your own profile. Note that, because an SMF forum may be customised extensively by its administrator(s), the features and user permissions described here are typical rather than definitive.';
...
$txt['manual_profile_email'] = 'Email address';
...
$txt['manual_profile_empty_part1'] = 'The fields left empty here are not completed by default so you should ';
...
$txt['manual_profile_send_member_pm_part2'] = ' by clicking the <strong>Current Status</strong> <strong>On/Offline Icon</strong> or following the link from <strong>Additional Information</strong>.';
...
$txt['manual_profile_normal_desc'] = 'The <strong>Summary</strong> screen is the same as the one shown above and the <strong>Show Posts</strong> and <strong>Show Stats</strong> links are effectively duplicates however profile owners are also provided with the tools to customise their own profiles.';
$txt['manual_profile_modify_profile'] = 'Modify Profile';
$txt['manual_profile_account_related'] = '<strong>Account Related Settings</strong> enables you to make changes to your <strong>display name</strong> (your <strong>login</strong> or <strong>username</strong> can only be changed by an administrator), preferred <strong>language</strong> (if the forum administrators have installed alternative language packs), <strong>email address</strong> and <strong>password</strong> settings.';
$txt['manual_profile_forum_profile_info'] = '<strong>Forum Profile Information</strong> enables you to enter optional personal details such as <strong>gender</strong>, <strong>birth date</strong>, <strong>location</strong>, <strong>website</strong> and <strong>instant messenger</strong> contact information. It is also where you go to enter your own <strong>personal text</strong> and <strong>signature</strong> and select an <strong>avatar</strong> (personal picture) from a list (if provided by the forum administrators) or link to one of your own on the web.';
...
$txt['manual_profile_look_layout_explanation'] = 'This section allows you to customise the look and layout of the forum.';
...
$txt['manual_profile_offset_hours'] = 'Number of hours +/- to make displayed time equal to your local time.';
...
$txt['manual_profile_no_ava'] = 'Do not show other user\'s avatars.';
$txt['manual_profile_no_sig'] = 'Do not show other user\'s signatures.';
...
$txt['manual_profile_recent_pms'] = 'Show most recent personal messages at the top.';
$txt['manual_profile_quick_reply'] = 'Use quick reply on topic display';
$txt['manual_profile_not_at_all'] = 'do not show at all';
...
$txt['manual_profile_no_quick_mod'] = 'do not show';
...
$txt['manual_profile_confirm_delete_acct'] = '<strong>Delete this account</strong> does exactly what it says! Yes, there is a <strong>confirmation screen</strong> but it really does <strong>delete your own account</strong> so be careful...';
...
$txt['manual_profile_track_ip'] = 'Track IP Address';
...
$txt['manual_profile_sub_track_user'] = '<strong>Track User</strong> provides a list of <strong>IP addresses</strong> used by the member, other members who might be in the same <strong>IP address range</strong> and <strong>error messages</strong> generated/experienced by the member.';
$txt['manual_profile_sub_track_ip'] = '<strong>Track IP Address</strong> provides tools for tracking <strong>members</strong>, <strong>messages</strong> and <strong>errors</strong> from any specified <strong>IP address range</strong>.';
...
$txt['manual_profile_sub_delete_acct'] = '<strong>Delete this account</strong> is similar to the screen of the same name available to all members but the <strong>confirmation question</strong> is different when it is not your own account that is about to be deleted.';

// Entries for template: registering.
$txt['manual_registering_you_have_arrived_part1'] = 'When you have set up your SMF forum or wish to join another SMF forum, you should register a username. This will enable you to maintain a consistent identity while posting and keep track of what you have read no matter where you are working from or what computer you are using. You will be able to complete a personal ';
$txt['manual_registering_you_have_arrived_link_profile'] = 'profile';
$txt['manual_registering_you_have_arrived_part2'] = ', use the built-in ';
$txt['manual_registering_you_have_arrived_link_profile_pm'] = 'personal message system';
$txt['manual_registering_you_have_arrived_part3'] = ', subscribe to email notifications, monitor your forum activity and more.';
$txt['manual_registering_sec_register'] = 'How to Register';
$txt['manual_registering_register_desc'] = 'Assuming you have arrived at the forum as a guest and wish to register, you should be looking at one of these two things:';
...
$txt['manual_registering_email'] = 'Email address';
...
$txt['manual_registering_reg_screen_requirements_part2'] = ' headed by a message inviting you to proceed, you are through and can proceed to login! If not, there are two further possibilities:';
$txt['manual_registering_email_activate'] = 'If registration has been configured to require email activation, the next screen will tell you so and you should receive an immediate email with instructions about how to proceed. There is also a useful link (\'Did you miss your activation email?\') in the <strong>User Info</strong> box in case you miss this email or mistype your email address.';
...
$txt['manual_searching_you_have_arrived'] = 'SMF incorporates a powerful search engine but knowing how to use it is, not surprisingly, the key to returning successful results!';
...
$txt['manual_searching_syntax_desc'] = 'You can just type, and search for, any combination of characters but you should consider using quotes<!-- and/or wildcards --> to make your search really work for you.';
...
$txt['manual_searching_simple_desc'] = 'The basic syntax outlined above is all you really need to know to use the simple search (if enabled). However, you might also like to know that this tool searches the entire forum for any or all of what you specify that has been posted during the last 9999 days (which is more than 27 years)! So you should use the advanced search feature to take more control of your search.';
$txt['manual_searching_sub_adv'] = 'Advanced Search';
$txt['manual_searching_adv_desc'] = 'The advanced search screen might initially seem a little intimidating if a forum has many boards and child boards but it is surprisingly straightforward when reduced to its basic components.';
...
$txt['manual_searching_choose'] = 'Choose a board in which to search or search all';
...
$txt['manual_searching_wildcard'] = 'The default * in the <strong>by user</strong> field is essentially a wildcard matching any poster. Note that while you can replace this with any <em>single</em> username for a more specific search, it is not currently possible to search for posts by multiple users except by using that single wildcard.';
$txt['manual_searching_results_as_messages'] = '<strong>Show results as messages</strong> returns the full message containing the search string (with a reply option) instead of the usual linked excerpt. This will naturally result in much larger results pages and might be significant if you are searching for a popular word or phrase.';
$txt['manual_searching_message_age'] = '<strong>Message age</strong> sets the minimum and maximum ages of posts to search.';
$txt['manual_searching_which_board'] = '<strong>Choose a board in which to search</strong> provides you with another tool to narrow the scope of the search with the default being \'All\' (the whole forum or, more properly, all the boards to which you have read access).';
$txt['manual_searching_search_button'] = 'The <strong>Search</strong> button not surprisingly sets the whole thing in motion but hitting \'Enter\' directly from any of the search fields is sometimes more convenient.';

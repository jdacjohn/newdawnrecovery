...
$helptxt['removeNestedQuotes'] = 'This will only show the quote of the post in question, not any other ones.';
...
$helptxt['attachmentEnable'] = 'Attachments are files that members can upload, and attach to a post.<br /><br />
		<b>Allow guests to post attachments?</b>:<br />  Select if guests can attach files to posts.<br />
		<b>Check Attachment Extension</b>:<br /> Do you want to check the extension of the files?<br />
		<b>Display Attachment as Picture in Post</b>:<br /> If the uploaded file is a picture, this will show it underneath the post<br />
		<b>Restrict attachments to member groups</b>:<br /> Set which groups can attach files<br />
		<b>Allowed Attachment Extensions</b>:<br /> You can set the allowed extensions of attached files.<br />
		<b>Attachments Upload Path</b>:<br /> The path to your attachment folder<br />(example: /home/sites/yoursite/www/forum/attachments)<br />
		<b>Attachments URL</b>:<br /> The URL to your attachment folder<br />(example: http://www.yoursite.com/forum/attachments)<br />
		<b>Max Attachment Size</b> (in kB):<br /> Select the maximum filesize of attachments.<br />
		<b>Max Attachment Folder Space</b> (in kB):<br /> Select how large the attachment folder can be.<br />';
...
$helptxt['queryless_urls'] = 'This changes the format of URLs a little so search engines will like them better.  They will look like index.php/action_profile/u_1.<br /><br />This feature will ' . (strpos(php_sapi_name(), 'apache') !== false ? '' : 'not') . ' work on your server.';
...
$helptxt['fixLongWords'] = 'This option breaks words longer than a certain length into pieces so they don\'t disturb the forum\'s layout. (as much...)';
...
$helptxt['guest_hideContacts'] = 'If selected this option will hide the email address\'s and messenger contact details
...
$helptxt['permissions_board'] = 'If a board is set to \'Global,\' it means that the board will not have any special permissions.  \'Local\' means it will have it\'s own permissions - separate from the global ones.  This allows you to have a board that has more or less permissions than another, without requiring you to set them for each and every board.';
...
$helptxt['see_member_ip'] = 'Your IP address is shown only to you and moderators.  Remember that this information is not identifying, and that most IPs change periodically.<br /><br />You cannot see other member\'s IP addresses, and they cannot see yours.';

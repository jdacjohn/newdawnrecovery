...
$txt[474] = 'Specify your own avatar by URL (eg: <b>http://www.mypage.com/mypic.gif</b>).';
...
$txt[519] = 'Number of hours +/- to make displayed time equal to your local time.';
$txt[563] = 'Date of Birth';
$txt[564] = 'Month (MM)';
$txt[565] = 'Day (DD)';
$txt[566] = 'Year (YYYY)';
$txt[596] = 'You should use six or more characters, with a combination of letters, numbers and symbols, for best security.';
...
$txt[606] = 'Signatures are displayed at the bottom of each post or personal message. BBC and smileys may be used in your signature.';
...
$txt['smf225'] = 'Language';
$txt['smf227'] = 'Avatar image is too large. Please resize it and try again (max';
$txt['smf233'] = 'Invalid Date Registered value, valid example:';
$txt['smf237'] = 'This is your MSN messenger email address.';
$txt['smf241'] = 'Current Password';
$txt['smf243'] = 'You have not entered your current password.';
// Don't use entities in the below string, except the main ones. (lt, gt, quot.)
$txt['smf244'] = 'Your current password is required, for security reasons, to make changes to your account.';
...
$txt['secret_desc2'] = 'Choose carefully as you would not want someone guessing your answer!';
$txt['pswd2'] = 'Answer';
$txt['pswd3'] = 'Ask me my question';
$txt['pswd4'] = 'You cannot retrieve your password but you can set a new one by following a link sent to you by email. You also have the option of setting a new password by answering your secret question.';
$txt['pswd5'] = 'Sorry, you have not specified a valid combination of Secret Question and Answer in your profile. Please click on the back button and use the default method of obtaining your password.';
$txt['pswd6'] = 'Enter the answer to your question and the password you would like to use. Your password will be changed to the one you select provided you answer the question correctly.';
...
$txt['notify_send_types'] = 'For topics and boards for which I have requested notification, notify me of';
...
$txt['notify_send_body'] = 'When sending notification of a reply to a topic, send the post in the email (but please do not reply to these emails).';
...
$txt['notifications_topics_howto'] = 'Click the &quot;notify&quot; button while viewing a topic to receive notifications from that topic.';
...
$txt['notifications_boards_none'] = 'You are not currently receiving notifications on any boards.';
$txt['notifications_boards_howto'] = 'Click the &quot;notify&quot; button in the index of a board to request notifications from that specific board.';
$txt['notifications_update'] = 'Unsubscribe';

$txt[325] = 'Ignore list';
$txt[326] = 'Add one Username on each line.<br />Enter * to ignore all messages.';
...
$txt['deleteAccount_desc'] = 'You can delete this user\'s account and posts from here.';
...
$txt['deleteAccount_approval'] = 'Note that the forum moderators will have to approve this account\'s deletion before it will be removed.';
...
$txt['trackIP'] = 'Track IP Address';

$txt['profileEdit'] = 'Modify Profile';
$txt['account'] = 'Account Related Settings';
$txt['account_info'] = 'These are your account settings. This page holds all critical information that identifies you on this forum. You will need to enter your (current) password, for security reasons, to make changes to this information.';
$txt['forumProfile'] = 'Forum Profile Information';
$txt['forumProfile_info'] = 'You can change your personal information here. This information will be displayed throughout ' . $context['forum_name'] . '. If you are not comfortable with sharing some information, simply skip it - nothing here is required.';
$txt['theme'] = 'Look and Layout Preferences';
$txt['theme_info'] = 'This section allows you to customise the look and layout of the forum.';
$txt['notification'] = 'Notifications and Email';
$txt['notification_info'] = 'SMF allows you to be notified of replies to posts, newly posted topics and forum announcements. You can change those settings here and oversee the topics and boards for which you are currently receiving notifications.';
...
$txt['enter_ip'] = 'Enter IP address (range)';
$txt['errors_by'] = 'Error messages by';
$txt['errors_desc'] = 'A list of all the recent errors that this user has generated/experienced is shown below.';
$txt['errors_from_ip'] = 'Error messages from IP address (range)';
$txt['errors_from_ip_desc'] = 'A list of all recent error messages generated by this IP address (range) is shown below.';
$txt['invalid_ip'] = 'Invalid IP address. Note that only asterisks (*) are allowed as masks (e.g. 127.0.*.*).';
$txt['ip_address'] = 'IP address';
$txt['ips_in_errors'] = 'IP addresses used in error messages';
$txt['ips_in_messages'] = 'IP addresses used in messages';
$txt['members_from_ip'] = 'Members from IP address (range)';
$txt['members_in_range'] = 'Members possibly in the same range';
$txt['messages_from_ip'] = 'Messages posted from IP address (range)';
$txt['messages_from_ip_desc'] = 'A list of all messages posted from this IP address (range) is shown below.';
$txt['most_recent_ip'] = 'Most recent IP address';
$txt['no_errors_from_ip'] = 'No error messages from the specified IP address (range) found.';
$txt['no_errors_from_user'] = 'No error messages from the specified user found.';
$txt['no_members_from_ip'] = 'No members from the specified IP address (range) found.';
...
$txt['view_ips_by'] = 'View IP addresses used by';

$txt['avatar_will_upload'] = 'I will upload my own picture';

// Use numeric entities in the below three strings.
$txt['activate_reactivate_title'] = 'Welcome back to';
$txt['activate_reactivate_mail'] = 'Your account has been deactivated in order to re-validate your email address.  Click the following link to activate it again:';
$txt['activate_changed_email'] = 'You have changed your email address and will receive an email in order to validate the new address. Click the link in that email to reactivate your account.';
...
$txt['smf100'] = 'Username/Email Address';

// Use numeric entities in the below two strings.
$txt['reminder_subject'] = 'New password for ' . $context['forum_name'];
$txt['reminder_mail'] = 'This mail was sent because the \'forgotten password\' function has been applied to your account. Click the following link to set a new password';
...
$txt['account_activate_method_2'] = 'Account requires reactivation after email address change';
...
$txt['no_new_reply_warning'] = 'Do not warn on new replies made while posting.';
...
$txt['recent_pms_at_top'] = 'Show most recent personal messages at the top.';
...
$txt['show_children'] = 'Show child boards on every page inside boards not just the first page.';
$txt['show_no_avatars'] = 'Do not show other users\' avatars.';
$txt['show_no_signatures'] = 'Do not show other users\' signatures.';
...
$txt['whois_title'] = 'Look up IP address on a regional WhoIs server';
...
$txt['moderator_why_missing'] = 'Why is Moderator not here?';

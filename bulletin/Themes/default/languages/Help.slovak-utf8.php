...
$txt[1006] = 'Zatvoriť okno';

$helptxt['manage_boards'] = '
	<b>Editovať Diskusie</b><br />
	V tomto menu môžete vytvárať/preskupovať/odoberať diskusie a kategórie
	nad nimi. Napríklad, ak máte web so širokým záberom,
	ktorý ponúka informácie o &quot;Športoch&quot; a &quot;Autách&quot; a &quot;Hudbe&quot;, tieto
	budú kategóriami najvyššej úrovne, ktoré vytvoríte. V každej z týchto 
	kategorií budete chcieť vytvoriť hierarchické &quot;Podkategórie&quot;,
	alebo &quot;Diskusie&quot; s témami v nich. Je to jednoduchá hierarchia s touto štruktúrou: <br />
	<ul>
		<li>
			<b>Športy</b>
			&nbsp;- &quot;kategória&quot;
		...
		<ul>
			<li>
				<b>Baseball</b>
				&nbsp;- Diskusia podriadená kategórii &quot;Športy&quot;
			</li>
			<ul>
				<li>
					<b>Štatistiky</b>
					&nbsp;- Dcérska diskusia podriadená diskusii &quot;Baseball&quot;
				</li>
			</ul>
			<li><b>Football</b>
			&nbsp;- Diskusia podriadená kategórii &quot;Športy&quot;</li>
		</ul>
	</ul>
	Kategórie vám dovolujú rozdeliť fórum na široko zamerané témy (&quot;Autá,
	Športy&quot;), a &quot;Diskusie&quot; im podriadené sú vlastné témy, kam
	môžu užívatelia prispievať. Užívateľ zaujmajúci sa o Trabanty
	by vytvoril správu v &quot;Autá->Trabanty&quot;. Kategórie umožňujú ľuďom
	rýchlo nájsť to, čo ich zaujíma: Namiesto &quot;Obchody&quot; máte kategórie
	&quot;Železiarstvo&quot; a &quot;Odevy&quot;. To zjednodušuje 
	hľadanie &quot;spojky trubiek&quot; pretože môžete ísť do &quot;kategórie&quot;Železiarstvo
	namiesto do Odevov (kde je nájdenie spojky trubiek málo pravdepodobné).<br />
	Ako je uvedené výššie, Diskusia je kľúčová téma podriadenej kategorie so širokým záberom.
	Ak sa chcete baviť o &quot;Trabantoch&quot; pôjdete do kategórie &quot;Autá&quot; a
	prejdete do diskusie &quot;Trabanty&quot;, aby ste sem pridali svoje myšlienky.<br />
	Administratívne funkcie pre túto položku menu sú vytvorenie novej diskusie
	v každej kategórii, ich preskupenie (posunúť &quot;Trabanty&quot; pred &quot;Škodovky&quot;), alebo
	určitú diskusiu vymazať úplne.';

$helptxt['edit_news'] = '<b>Editovať Novinky fóra</b><br />
	Táto položka vám dovoluje nastaviť text pre správy zobrazované na Board Index page.
	Pridajte požadovanú pložku (napr., &quot;Nepremeškajte konferenciu LINUXPO tento útorok&quot;). Každá položka správ by mala 
	byť zaradená do zvláštneho oddielu a sú zobrazované náhodne.';

$helptxt['view_members'] = '
	<ul>
		<li>
			<b>Zobraz všetkých užívateľov</b><br />
			Zobrazí všetkých užívateľov fóra. Poskytne nalinkovaný zoznam mien užívateľov. Môžete kliknuť
			na ktorékoľvek z týchto mien pre zobrazenie detailov užívateľa (homepage, vek, atď.), a ako Administrátor
			môžete modifikovať tieto parametre. Máte kompletnú kontrolu nad užívateľmi, vrátane
			možnosti ich odstrániť z fóra.<br /><br />
		</li>
		<li>
			<b>Čaká sa na schválenie</b><br />
			Táto sekcia je zobrazená iba ak máte zapnuté schvalovanie všetkých nových registrácií administrátorom. Ktokoľvek sa zaregistruje na vašom
			fóre sa stane plnoprávnym užívateľom až po schválení administrátorom. Táto sekcia zobrazí všetkých užívateľov, ktorí
			ešte stále čakajú na schválenie, spolu s ich emailom a IP adresou. Môžete si vybrať či ich prijmete alebo odmietnete (zmažete)
			ktoréhokoľvek užívateľa na zozname zašktnutím políčka vedľa neho a zvolením akcie z rozbalovacieho políčka naspodku stránky.
      Pri odmietnutí užívateľa si môžete vybrať, či ho zažete a dáte mu to na vedomie, alebo mu vaše rozhodnutie neoznámite.<br /><br />
		</li>
		<li>
			<b>Čaká sa na aktiváciu</b><br />
			Táto sekcia je zobrazená iba ak máte vo fóre zapnuté aktivovanie užívateľských účtov. Táto sekcia zobrazí všetkých užívateľov, 
      ktorí ešte neaktivovali svoj nový účet. Na tejto stránke môžete vybrať či príjmete, odmietnete alebo upozorníte
			členov s nedokončenou registráciou. Tiež si môžete vybrať, či užívateľovi pošlete email s informáciou o vykonanej akcii.<br /><br />
		</li>
	</ul>';

$helptxt['ban_members'] = '<b>Zakázanie užívateľov</b><br />
	SMF poskytuje možnosť &quot;zakázať&quot; užívateľov, čo zabráni ľuďom , ktorí porušili pravidlá fóra
	spamovaním, trollingom, atď. To vám dovolí zbaviť sa užívateľov škodiacich fóru. Ako admin, vidíte
	pri prezeraní správ IP adresu každého užívateľa, ktorú použil pri zaslaní príspevku. Do zoznamu zákazov
	jednoducho napíšete danú IP adresu, uložíte a užívatelia už ďalej nemôžu z toho miesta prispievať.<br />Môžete tiež
	zakázať užívateľov podľa ich emailových adries.';
  ...
  sekce, viditelné podle nastavení fóra. Jsou to:<br /><br />
	<ul>
      ...
      zvolit zaslání emailem uživatelům nové heslo na uvedenou emailovou adresu.<br /><br />
		...
		<li>
			<b>Editovat registrační smluvu</b><br />
...
$helptxt['error_log'] = '<b>Log chyb</b><br />
	Log chyb zaznamenává všechny vážné chyby, se kterými se setkali uživatelé fóra. It lists all of these errors by date which can be sorted
...
$helptxt['theme_settings'] = '<b>Nastavení motivu</b><br />
	Stránka nastavení ti umožňuje změnit vlastnosti zvoleného motivu. Tyto nastavení zahrnují možnosti jako adresář motivu nebo URL informace, ale
	také volby, které ovlivňují rozvržení motivu na fóru. Většina motivů bude mít mnoho druhů užvatelsky nastavitelných možností, umožňujících přizpůsobení motivu
...
$helptxt['localCookies'] = 'SMF používá koláčky (cookies) pro ukládání informací o přihlášení na klientském počítači.
...
$helptxt['guest_hideContacts'] = 'Je-li zaškrtnuta, tato volba skryje e-mailovou adresu a další kontaktní údaje (MSN mesenger, ICQ...) před ostatními uživateli fóra.';

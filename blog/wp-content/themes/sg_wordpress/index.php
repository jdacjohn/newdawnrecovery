...
<table width="780" height="55" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		...
		<td background="wp-content/themes/sg_wordpress/images/top_02.jpg" width="699" height="17" valign="top">
		
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
		<?php if ( $user_ID ) { ?>
			<td>
				<font>Logged in as </font><a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>.
			</td>		
			<td align="right">
			
				<a href="<?php echo get_option('siteurl'); ?>/wp-login.php?action=logout" title="Log out of this account"><img src="wp-content/themes/sg_wordpress/images/logout.jpg" border="0"></a>
			</td>
		<?php } else {?>
			<td>
			</td>		
			<td align="right">
				<a href="<?php echo get_option('siteurl'); ?>/wp-login.php?action=login" title="Log in of this site"><img src="wp-content/themes/sg_wordpress/images/login.jpg" border="0"></a>
			</td>
		<?php } ?>
...
<?php include("wp-content/themes/sg_wordpress/templates.php") ?>

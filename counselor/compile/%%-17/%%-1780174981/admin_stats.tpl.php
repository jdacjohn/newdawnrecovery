<?php /* Smarty version 2.6.1, created on 2012-05-09 14:21:14
         compiled from admin_stats.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'admin_stats.tpl', 7, false),)), $this); ?>
...
</b> (<?php echo $this->_tpl_vars['dates']; ?>
)</td>
  </tr>
  <tr class="<?php echo smarty_function_cycle(array('values' => "alt,"), $this);?>
">
    <td width="200"><?php echo $this->_tpl_vars['lang']['chat_requests']; ?>
:</td>
...
<br />
<input type="submit" name="view" value="<?php echo $this->_tpl_vars['lang']['view']; ?>
">
</form>
</div>
...
<br /><input type="submit" name="view" value="<?php echo $this->_tpl_vars['lang']['view']; ?>
">
</form>
</div>
...
<table cellspacing="0" cellpadding="0" width="100%" class="list">
 ...
 (<?php echo $this->_tpl_vars['operator']['username']; ?>
  ...
  <tr class="<?php echo smarty_function_cycle(array('values' => "alt,"), $this);?>
">
    <td width="200"><?php echo $this->_tpl_vars['lang']['online_time']; ?>
:</td>

<?php /* Smarty version 2.6.1, created on 2012-05-09 13:54:51
         compiled from admin_code.tpl */ ?>
<div align="center">
<?php if ($this->_tpl_vars['action'] == 'text'): ?>
<b><?php echo $this->_tpl_vars['lang']['text_code']; ?>
</b>
<?php elseif ($this->_tpl_vars['action'] == 'image'): ?>
<b><?php echo $this->_tpl_vars['lang']['image_code']; ?>
</b>
<?php elseif ($this->_tpl_vars['action'] == 'html'): ?>
<b><?php echo $this->_tpl_vars['lang']['html_code']; ?>
</b>
<?php elseif ($this->_tpl_vars['action'] == 'invisible'): ?>
<b><?php echo $this->_tpl_vars['lang']['invisible_code']; ?>
</b>
<?php endif; ?>
<br /><br />
...
<br />
<input type="submit" name="submit" value="<?php echo $this->_tpl_vars['lang']['generate_code']; ?>
">
</form>

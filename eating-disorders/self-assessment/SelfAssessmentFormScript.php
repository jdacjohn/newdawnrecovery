...
//	if($send) {
//		header( "Location: http://192.168.1.197/newdawnts.org/testSite/eatingdisorders/selfassessment/SelfAssessmentFormThankYou.php?a=" . $often . "&b=" . $sometimes . "&c=" . $rarely . "&d=" . $never );
		header( "Location: http://www.newdawntreatmentcenters.com/eating-disorders/self-assessment/SelfAssessmentFormThankYou.php?a=" . $often . "&b=" . $sometimes . "&c=" . $rarely . "&d=" . $never );
//	} else {

...
(function ($) {
    $.fn.tipTip = function (options) {
        var defaults = {
            ...
            maxWidth: '500px', // The max-width to set on the tooltip. You may also use the option cssClass to set this.
            edgeOffset: 0, // The offset between the tooltip arrow edge and the element that has the tooltip.
            defaultPosition: 'top', // The position of the tooltip. Can be: top, right, bottom and left.
            ...
            detectTextDir: false // When false auto-detection for right-to-left text will be disable (When true affects a bit the performance).
        };
